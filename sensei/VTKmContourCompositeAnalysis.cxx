...
//-----------------------------------------------------------------------------
VTKmContourCompositeAnalysis::VTKmContourCompositeAnalysis() : Communicator(MPI_COMM_WORLD), Helper(NULL)
{
...
void VTKmContourCompositeAnalysis::AddContour(double value)
{
    ...
    mapper->SetTimerStartCallback(timer::MarkStartEvent);
    mapper->SetTimerFinishCallback(timer::MarkEndEvent);
