  ...
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      coprocessor.RegisterView(renderView1,
          filename='receiver_decomp_%t.png', freq=1, fittoscreen=0, magnification=1, width=800, height=600, cinema={})
      ...
      extractEdges1 = ExtractEdges(Input=mesh)

      # create a new 'Slice'
      slice2 = Slice(Input=mesh)
      ...
      # get color transfer function/color map for 'ReceiverBlockOwner'
      receiverBlockOwnerLUT = GetColorTransferFunction('ReceiverBlockOwner')
      ...
      slice2Display.ColorArrayName = ['CELLS', 'ReceiverBlockOwner']
      ...
      # get opacity transfer function/opacity map for 'ReceiverBlockOwner'
      receiverBlockOwnerPWF = GetOpacityTransferFunction('ReceiverBlockOwner')
