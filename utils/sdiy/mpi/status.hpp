...
bool
sdiy::mpi::status::cancelled() const
{
#ifndef DIY_NO_MPI
  int flag;
  ...
  return flag;
#else
  DIY_UNSUPPORTED_MPI_CALL(sdiy::mpi::status::cancelled);
#endif
}

template<class T>
int
sdiy::mpi::status::count() const
{
#ifndef DIY_NO_MPI
  int c;
  ...
  return c;
#else
  DIY_UNSUPPORTED_MPI_CALL(sdiy::mpi::status::count);
#endif
}
