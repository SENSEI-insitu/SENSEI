...
namespace sdiy
{
    ...
    void    fix_links(sdiy::Master& master, sdiy::DynamicAssigner& assigner);

    // auxiliary functions; could stick them into detail namespace, but they might be useful on their own
    void    record_local_gids(const sdiy::Master& master, sdiy::DynamicAssigner& assigner);
    void    update_links(sdiy::Master& master, const sdiy::DynamicAssigner& assigner);
}

void
sdiy::
record_local_gids(const sdiy::Master& master, sdiy::DynamicAssigner& assigner)
{
...
void
sdiy::
update_links(sdiy::Master& master, const sdiy::DynamicAssigner& assigner)
{
...
void
sdiy::
fix_links(sdiy::Master& master, sdiy::DynamicAssigner& assigner)
{
