...
struct KDTreeSamplingPartition
{
    ...
    void        compute_local_samples(Block* b, const sdiy::ReduceProxy& srp, int dim) const;
    void        add_samples(Block* b, const sdiy::ReduceProxy& srp, Samples& samples) const;
    void        receive_samples(Block* b, const sdiy::ReduceProxy& srp,       Samples& samples) const;
    void        forward_samples(Block* b, const sdiy::ReduceProxy& srp, const Samples& samples) const;

    void        enqueue_exchange(Block* b, const sdiy::ReduceProxy& srp, int dim, const Samples& samples) const;
...
template<class Block, class Point>
void
sdiy::detail::KDTreeSamplingPartition<Block,Point>::
...
void
sdiy::detail::KDTreeSamplingPartition<Block,Point>::
compute_local_samples(Block* b, const sdiy::ReduceProxy& srp, int dim) const
{
...
void
sdiy::detail::KDTreeSamplingPartition<Block,Point>::
add_samples(Block* b, const sdiy::ReduceProxy& srp, Samples& samples) const
{
...
void
sdiy::detail::KDTreeSamplingPartition<Block,Point>::
receive_samples(Block* b, const sdiy::ReduceProxy& srp, Samples& samples) const
{
...
void
sdiy::detail::KDTreeSamplingPartition<Block,Point>::
forward_samples(Block* b, const sdiy::ReduceProxy& srp, const Samples& samples) const
{
...
void
sdiy::detail::KDTreeSamplingPartition<Block,Point>::
enqueue_exchange(Block* b, const sdiy::ReduceProxy& srp, int dim, const Samples& samples) const
{
    int         lid  = srp.master()->lid(srp.gid());
    RCLink*     link = static_cast<RCLink*>(srp.master()->link(lid));
