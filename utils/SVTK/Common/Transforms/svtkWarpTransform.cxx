...
//----------------------------------------------------------------------------
void svtkWarpTransform::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
svtkWarpTransform::svtkWarpTransform()
{
  this->InverseFlag = 0;
...
//----------------------------------------------------------------------------
svtkWarpTransform::~svtkWarpTransform() = default;

//------------------------------------------------------------------------
// Check the InverseFlag, and perform a forward or reverse transform
// as appropriate.
template <class T>
void svtkWarpTransformPoint(svtkWarpTransform* self, int inverse, const T input[3], T output[3])
{
  if (inverse)
  {
...
void svtkWarpTransform::InternalTransformPoint(const float input[3], float output[3])
{
  svtkWarpTransformPoint(this, this->InverseFlag, input, output);
}

void svtkWarpTransform::InternalTransformPoint(const double input[3], double output[3])
{
  svtkWarpTransformPoint(this, this->InverseFlag, input, output);
}
...
// appropriate.
template <class T>
void svtkWarpTransformDerivative(
  svtkWarpTransform* self, int inverse, const T input[3], T output[3], T derivative[3][3])
{
  if (inverse)
  {
    self->TemplateTransformInverse(input, output, derivative);
    svtkMath::Invert3x3(derivative, derivative);
  }
  else
  {
...
void svtkWarpTransform::InternalTransformDerivative(
  const float input[3], float output[3], float derivative[3][3])
{
  svtkWarpTransformDerivative(this, this->InverseFlag, input, output, derivative);
}
...
// singular.
template <class T>
void svtkWarpInverseTransformPoint(
  svtkWarpTransform* self, const T point[3], T output[3], T derivative[3][3])
{
  ...
  svtkDebugWithObjectMacro(self, "Inverse Iterations: " << (i + 1));
...
void svtkWarpTransform::InverseTransformPoint(const float point[3], float output[3])
{
  float derivative[3][3];
  svtkWarpInverseTransformPoint(this, point, output, derivative);
}

void svtkWarpTransform::InverseTransformPoint(const double point[3], double output[3])
{
...
//----------------------------------------------------------------------------
void svtkWarpTransform::InverseTransformDerivative(
...
void svtkWarpTransform::Inverse()
{
