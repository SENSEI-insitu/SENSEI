/*=========================================================================
  ...
  Module:    svtkMatrixToHomogeneousTransform.h
...
/**
 * @class   svtkMatrixToHomogeneousTransform
 * @brief   convert a matrix to a transform
 *
 * This is a very simple class which allows a svtkMatrix4x4 to be used in
 * place of a svtkHomogeneousTransform or svtkAbstractTransform.  For example,
 ...
 * @sa
 * svtkPerspectiveTransform svtkMatrix4x4 svtkMatrixToLinearTransform
 */

#ifndef svtkMatrixToHomogeneousTransform_h
#define svtkMatrixToHomogeneousTransform_h
...
class SVTKCOMMONTRANSFORMS_EXPORT svtkMatrixToHomogeneousTransform : public svtkHomogeneousTransform
{
public:
  static svtkMatrixToHomogeneousTransform* New();
  svtkTypeMacro(svtkMatrixToHomogeneousTransform, svtkHomogeneousTransform);
...
protected:
  ...
  ~svtkMatrixToHomogeneousTransform() override;
...
private:
  svtkMatrixToHomogeneousTransform(const svtkMatrixToHomogeneousTransform&) = delete;
  void operator=(const svtkMatrixToHomogeneousTransform&) = delete;
};
