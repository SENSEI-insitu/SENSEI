...
=========================================================================*/
/**
 * @class   svtkGeneralTransform
 * @brief   allows operations on any transforms
 *
 * svtkGeneralTransform is like svtkTransform and svtkPerspectiveTransform,
 * but it will work with any svtkAbstractTransform as input.  It is
 ...
 * @sa
 * svtkTransform svtkPerspectiveTransform
 */

#ifndef svtkGeneralTransform_h
#define svtkGeneralTransform_h
...
class SVTKCOMMONTRANSFORMS_EXPORT svtkGeneralTransform : public svtkAbstractTransform
{
public:
  static svtkGeneralTransform* New();

  svtkTypeMacro(svtkGeneralTransform, svtkAbstractTransform);
   ...
   */
  svtkAbstractTransform* GetConcatenatedTransform(int i)
  {
   ...
   */
  void SetInput(svtkAbstractTransform* input);
  svtkAbstractTransform* GetInput() { return this->Input; }
  //@}
...
private:
  svtkGeneralTransform(const svtkGeneralTransform&) = delete;
  void operator=(const svtkGeneralTransform&) = delete;
};
