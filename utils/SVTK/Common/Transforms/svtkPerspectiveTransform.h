/*=========================================================================
  ...
  Module:    svtkPerspectiveTransform.h
 ...
 *
 * A svtkPerspectiveTransform can be used to describe the full range of
 ...
 * a transformation pipeline with svtkPerspectiveTransform.  See svtkTransform
 * for more information on the transformation pipeline.
 * @sa
 * svtkGeneralTransform svtkTransform svtkMatrix4x4 svtkCamera
 */

#ifndef svtkPerspectiveTransform_h
#define svtkPerspectiveTransform_h
...
class SVTKCOMMONTRANSFORMS_EXPORT svtkPerspectiveTransform : public svtkHomogeneousTransform
{
public:
  static svtkPerspectiveTransform* New();
  svtkTypeMacro(svtkPerspectiveTransform, svtkHomogeneousTransform);
   ...
   */
  void Concatenate(svtkHomogeneousTransform* transform);
   ...
   */
  svtkHomogeneousTransform* GetConcatenatedTransform(int i)
  {
    ...
    return static_cast<svtkHomogeneousTransform*>(t);
  }
  //@}
   ...
   */
  void SetInput(svtkHomogeneousTransform* input);
  svtkHomogeneousTransform* GetInput() { return this->Input; }
  //@}
...
protected:
  ...
  ~svtkPerspectiveTransform() override;

  void InternalDeepCopy(svtkAbstractTransform* t) override;
  void InternalUpdate() override;

  svtkHomogeneousTransform* Input;
  svtkTransformConcatenation* Concatenation;
  svtkTransformConcatenationStack* Stack;

private:
  svtkPerspectiveTransform(const svtkPerspectiveTransform&) = delete;
  void operator=(const svtkPerspectiveTransform&) = delete;
};
