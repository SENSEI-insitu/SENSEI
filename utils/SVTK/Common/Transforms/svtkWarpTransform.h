...
=========================================================================*/
/**
 * @class   svtkWarpTransform
 * @brief   superclass for nonlinear geometric transformations
 *
 * svtkWarpTransform provides a generic interface for nonlinear
 * warp transformations.
 * @sa
 * svtkThinPlateSplineTransform svtkGridTransform svtkGeneralTransform
 */

#ifndef svtkWarpTransform_h
#define svtkWarpTransform_h

#include "svtkAbstractTransform.h"
#include "svtkCommonTransformsModule.h" // For export macro

class SVTKCOMMONTRANSFORMS_EXPORT svtkWarpTransform : public svtkAbstractTransform
{
public:
  svtkTypeMacro(svtkWarpTransform, svtkAbstractTransform);
   ...
   */
  svtkSetMacro(InverseTolerance, double);
  svtkGetMacro(InverseTolerance, double);
  //@}
   ...
   */
  svtkSetMacro(InverseIterations, int);
  svtkGetMacro(InverseIterations, int);
  //@}
...
private:
  svtkWarpTransform(const svtkWarpTransform&) = delete;
  void operator=(const svtkWarpTransform&) = delete;
};
