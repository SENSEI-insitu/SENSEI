...
static void SetTransform(svtkTransform* transform, int dimensionality, double rotX, double rotY,
...
static int TestTransform(Conditions c)
{
  ...
  svtkNew<svtkTransform> sourceTransform;
  ...
  svtkNew<svtkTransform> targetTransform;
  ...
  svtkNew<svtkPoints> sourcePoints;
  svtkNew<svtkPoints> targetPoints;
  ...
  svtkNew<svtkThinPlateSplineTransform> ltrans;
  ltrans->SetBasisToR();
  ...
  {
    svtkNew<svtkPoints> transformedSourcePoints;
    ...
    for (int i = 0; i < npoints; i++)
    {
      ...
      double d = svtkMath::Distance2BetweenPoints(targetPoint, transformedSourcePoint);
      dmax = (dmax > d ? dmax : d);
      dsum += d;
    }
  ...
  {
    ltrans->Inverse();
    svtkNew<svtkPoints> transformedTargetPoints;
    ...
    for (int i = 0; i < npoints; i++)
    {
      ...
      double d = svtkMath::Distance2BetweenPoints(sourcePoint, transformedTargetPoint);
      dmax = (dmax > d ? dmax : d);
      dsum += d;
    }
