...
svtkStandardNewMacro(svtkRungeKutta4);

svtkRungeKutta4::svtkRungeKutta4()
{
  for (int i = 0; i < 3; i++)
  {
...
void svtkRungeKutta4::Initialize()
{
...
// (Addison Wesley)
int svtkRungeKutta4::ComputeNextStep(double* xprev, double* dxprev, double* xnext, double t,
...
void svtkRungeKutta4::PrintSelf(ostream& os, svtkIndent indent)
{
