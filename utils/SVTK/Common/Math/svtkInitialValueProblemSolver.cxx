/*=========================================================================
  ...
  Module:    svtkInitialValueProblemSolver.cxx
...
svtkInitialValueProblemSolver::svtkInitialValueProblemSolver()
{
...
void svtkInitialValueProblemSolver::SetFunctionSet(svtkFunctionSet* fset)
{
  if (this->FunctionSet != fset)
  {
    ...
    {
      svtkErrorMacro("Invalid function set!");
      this->FunctionSet = nullptr;
      return;
    }
...
void svtkInitialValueProblemSolver::PrintSelf(ostream& os, svtkIndent indent)
{
...
void svtkInitialValueProblemSolver::Initialize()
{
  if (!this->FunctionSet)
  {
    return;
