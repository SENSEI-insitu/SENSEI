...
static void svtkFunctionToMinimize(void* arg)
{
  svtkAmoebaMinimizer* minimizer = static_cast<svtkAmoebaMinimizer*>(arg);
...
{
  svtkAmoebaMinimizer* minimizer = svtkAmoebaMinimizer::New();

  minimizer->SetFunction(&svtkFunctionToMinimize, minimizer);
