...
//-----------------------------------------------------------------------------
// Destructor for the svtkWindow object.
svtkWindow::~svtkWindow()
{
...
//-----------------------------------------------------------------------------
void svtkWindow::SetSize(int a[2])
{
  this->SetSize(a[0], a[1]);
}

//-----------------------------------------------------------------------------
void svtkWindow::SetSize(int width, int height)
{
  if (this->Size[0] != width || this->Size[1] != height)
  {
    ...
    this->Size[1] = height;
    this->Modified();
    this->InvokeEvent(svtkCommand::WindowResizeEvent, nullptr);
  }
}

//-----------------------------------------------------------------------------
int* svtkWindow::GetPosition()
{
  return this->Position;
}

//-----------------------------------------------------------------------------
void svtkWindow::SetPosition(int a[2])
{
  this->SetPosition(a[0], a[1]);
}

//-----------------------------------------------------------------------------
void svtkWindow::SetPosition(int x, int y)
{
...
//-----------------------------------------------------------------------------
void svtkWindow::PrintSelf(ostream& os, svtkIndent indent)
{
