/*=========================================================================
  ...
  Module:    svtkMinimalStandardRandomSequence.h
 ...
 *
 * svtkMinimalStandardRandomSequence is a sequence of statistically independent
...
#ifndef svtkMinimalStandardRandomSequence_h
#define svtkMinimalStandardRandomSequence_h

#include "svtkCommonCoreModule.h" // For export macro
#include "svtkRandomSequence.h"

class SVTKCOMMONCORE_EXPORT svtkMinimalStandardRandomSequence : public svtkRandomSequence
{
public:
  //@{
  /**
   ...
   */
  static svtkMinimalStandardRandomSequence* New();
  svtkTypeMacro(svtkMinimalStandardRandomSequence, svtkRandomSequence);
   ...
   */
  void Initialize(svtkTypeUInt32 seed) override { this->SetSeed(seed); }
...
protected:
  ...
  ~svtkMinimalStandardRandomSequence() override;

  int Seed;

private:
  svtkMinimalStandardRandomSequence(const svtkMinimalStandardRandomSequence&) = delete;
  void operator=(const svtkMinimalStandardRandomSequence&) = delete;
};

#endif // #ifndef svtkMinimalStandardRandomSequence_h
