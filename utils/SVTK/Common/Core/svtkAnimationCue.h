...
#ifndef svtkAnimationCue_h
#define svtkAnimationCue_h

#include "svtkCommonCoreModule.h" // For export macro
#include "svtkObject.h"

class SVTKCOMMONCORE_EXPORT svtkAnimationCue : public svtkObject
{
public:
  svtkTypeMacro(svtkAnimationCue, svtkObject);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  static svtkAnimationCue* New();
   ...
   * over the span of the container Scene (when in Normalized time mode).
   */
  svtkSetMacro(EndTime, double);
  svtkGetMacro(EndTime, double);
  //@}
   ...
   */
  svtkGetMacro(AnimationTime, double);
  //@}
...
private:
  svtkAnimationCue(const svtkAnimationCue&) = delete;
  void operator=(const svtkAnimationCue&) = delete;
};
