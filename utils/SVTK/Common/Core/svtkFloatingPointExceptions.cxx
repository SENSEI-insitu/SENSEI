/*=========================================================================
  ...
  Module:    svtkFloatingPointExceptions.cxx
...
#include "svtkFloatingPointExceptionsConfigure.h"

#if defined(SVTK_USE_FENV)
#include <csignal>
#include <fenv.h>
#endif
...
void svtkFloatingPointExceptions::Enable()
{
#ifdef _MSC_VER
...
void svtkFloatingPointExceptions::Disable()
{
#ifdef _MSC_VER
