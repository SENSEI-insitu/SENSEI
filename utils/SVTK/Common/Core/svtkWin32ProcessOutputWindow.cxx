/*=========================================================================
  ...
  Module:    svtkWin32ProcessOutputWindow.cxx
...
=========================================================================*/
#include "svtkWin32ProcessOutputWindow.h"
...
svtkStandardNewMacro(svtkWin32ProcessOutputWindow);

extern "C" int svtkEncodedArrayWin32OutputWindowProcessWrite(const char* fname);

//----------------------------------------------------------------------------
svtkWin32ProcessOutputWindow::svtkWin32ProcessOutputWindow()
{
  this->OutputPipe = 0;
  this->Broken = 0;
  this->Count = 0;
...
//----------------------------------------------------------------------------
void svtkWin32ProcessOutputWindow::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void svtkWin32ProcessOutputWindow::DisplayText(const char* text)
{
...
//----------------------------------------------------------------------------
int svtkWin32ProcessOutputWindow::Initialize()
{
  ...
  snprintf(exeName, sizeof(exeName), "svtkWin32OWP_%" PRIdword "_%p_%u.exe", GetCurrentProcessId(),
    this, this->Count++);
  ...
  if (!svtkEncodedArrayWin32OutputWindowProcessWrite(exeFullPath))
  {
    free(exeFullPath);
    return 0;
  }
...
//----------------------------------------------------------------------------
void svtkWin32ProcessOutputWindow::Write(const char* data, size_t length)
{
  if (data && length)
  {
