...
#ifndef svtkTypeList_txx
#define svtkTypeList_txx
...
{
  using type = svtkTypeList::TypeList<T1,
    svtkTypeList::TypeList<T2,
      svtkTypeList::TypeList<T3, svtkTypeList::TypeList<T4, svtkTypeList::NullType> > > >;
};
...
{
  using type = svtkTypeList::TypeList<T1,
    svtkTypeList::TypeList<T2, svtkTypeList::TypeList<T3, svtkTypeList::NullType> > >;
};

template <typename T1, typename T2>
struct CreateImpl<T1, T2>
{
  using type = svtkTypeList::TypeList<T1, svtkTypeList::TypeList<T2, svtkTypeList::NullType> >;
};

template <typename T1>
struct CreateImpl<T1>
{
  using type = svtkTypeList::TypeList<T1, svtkTypeList::NullType>;
};
...
struct CreateImpl<T1, T2, T3, T4, Tail...>
{
  using type = svtkTypeList::TypeList<T1,
    svtkTypeList::TypeList<T2,
      svtkTypeList::TypeList<T3,
        svtkTypeList::TypeList<T4, typename svtkTypeList::detail::CreateImpl<Tail...>::type> > > >;
};
...
template <>
struct Append<svtkTypeList::NullType, svtkTypeList::NullType>
{
...
template <typename T>
struct Append<svtkTypeList::NullType, T>
{
  typedef svtkTypeList::TypeList<T, svtkTypeList::NullType> Result;
};

// Terminal case (TypeList):
template <typename Head, typename Tail>
struct Append<svtkTypeList::NullType, svtkTypeList::TypeList<Head, Tail> >
{
  typedef svtkTypeList::TypeList<Head, Tail> Result;
};

// Recursive case:
template <typename Head, typename Tail, typename T>
struct Append<svtkTypeList::TypeList<Head, Tail>, T>
{
  typedef svtkTypeList::TypeList<Head, typename Append<Tail, T>::Result> Result;
};

}

#endif // svtkTypeList_txx
