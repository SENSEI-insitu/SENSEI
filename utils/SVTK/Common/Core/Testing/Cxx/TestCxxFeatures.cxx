...
#if !defined(SVTK_TYPENAME)
#define SVTK_TYPENAME typename
#endif

// Assume standard behavior if symbol is not already defined.
#if !defined(SVTK_CLASS_TEMPLATE_SPECIALIZATION)
#define SVTK_CLASS_TEMPLATE_SPECIALIZATION template <>
#endif
...
SVTK_CLASS_TEMPLATE_SPECIALIZATION
...
{
  typedef SVTK_TYPENAME FullySpecializedClass<T>::Type Type;
