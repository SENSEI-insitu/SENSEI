...
int TestDataArrayComponentNames(int, char*[])
{
  ...
  // Test Down cast
  svtkDoubleArray* downcast = svtkArrayDownCast<svtkDoubleArray>(farray);
  ...
  // DeepCopy
  svtkDoubleArray* deepCopy = svtkDoubleArray::New();
