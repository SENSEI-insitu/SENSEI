...
static const svtkTypeUInt16 sample_utf16[] = { 0x0041, // 'a'
  0x0020,                                             // ' '
...
int TestUnicodeStringAPI(int, char*[])
{
  try
  {
    ...
    a = svtkUnicodeString::from_utf8(sample_utf8_ascii);
    test_expression(!a.empty());
    ...
    a = svtkUnicodeString::from_utf8(sample_utf8_greek);
    ...
    a = svtkUnicodeString::from_utf8(sample_utf8_mixed);
    ...
    svtkUnicodeString b = svtkUnicodeString::from_utf8(sample_utf8_ascii);
    ...
    a = svtkUnicodeString::from_utf16(sample_utf16);
    test_expression(a.character_count() == 4);
    ...
    a = svtkUnicodeString::from_utf8("Hello, World!");
    test_expression(a.substr(7) == svtkUnicodeString::from_utf8("World!"));
    test_expression(a.substr(1, 4) == svtkUnicodeString::from_utf8("ello"));
