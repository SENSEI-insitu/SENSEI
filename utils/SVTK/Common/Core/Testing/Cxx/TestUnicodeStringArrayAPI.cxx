...
static const svtkUnicodeString sample_utf8_ascii = svtkUnicodeString::from_utf8("abcde123");
static const svtkUnicodeString sample_utf8_greek =
  svtkUnicodeString::from_utf8("\xce\xb1\xce\xb2\xce\xb3"); // Greek lower-case alpha, beta, gamma.
static const svtkUnicodeString sample_utf8_thai = svtkUnicodeString::from_utf8(
  "\xe0\xb8\x81\xe0\xb8\x82\xe0\xb8\x83"); // Thai ko kai, kho khai, kho khuat.
static const svtkUnicodeString sample_utf8_linear_b = svtkUnicodeString::from_utf8(
  "\xf0\x90\x80\x80\xf0\x90\x80\x81\xf0\x90\x80\x82\xf0\x90\x80\x83\xf0\x90\x80\x84"); // Linear-B
                                                                                       // syllables
                                                                                       // a, e, i,
                                                                                       // o, u.
static const svtkUnicodeString sample_utf8_mixed = svtkUnicodeString::from_utf8(
...
int TestUnicodeStringArrayAPI(int, char*[])
{
  try
  {
    svtkSmartPointer<svtkUnicodeStringArray> array = svtkSmartPointer<svtkUnicodeStringArray>::New();
    array->ClearLookup(); // noop
    test_expression(array->GetNumberOfTuples() == 0);
    test_expression(array->GetDataType() == SVTK_UNICODE_STRING);
    ...
    array->InsertNextValue(svtkUnicodeString::from_utf8("foo"));
    test_expression(array->GetNumberOfTuples() == 2);
    test_expression(array->LookupValue(svtkUnicodeString::from_utf8("foo")) == 1);
    test_expression(array->LookupValue(svtkUnicodeString::from_utf8("bar")) == -1);

    svtkSmartPointer<svtkUnicodeStringArray> array2 = svtkSmartPointer<svtkUnicodeStringArray>::New();
    ...
    test_expression(array2->GetValue(100) == svtkUnicodeString::from_utf8("foo"));
    ...
    svtkSmartPointer<svtkUnicodeStringArray> array3 = svtkSmartPointer<svtkUnicodeStringArray>::New();
    ...
    svtkSmartPointer<svtkIdList> toIds = svtkSmartPointer<svtkIdList>::New();
    svtkSmartPointer<svtkIdList> fromIds = svtkSmartPointer<svtkIdList>::New();
    ...
    array3->InsertNextValue(svtkUnicodeString::from_utf8("foobar"));
    array3->InsertNextValue(svtkUnicodeString::from_utf8("foobar"));
    array3->InsertNextValue(svtkUnicodeString::from_utf8("foobar"));
    svtkSmartPointer<svtkIdList> lookupIds = svtkSmartPointer<svtkIdList>::New();
    array3->LookupValue(svtkUnicodeString::from_utf8("foobar"), lookupIds);
    ...
    svtkSmartPointer<svtkUnicodeStringArray> array4 = svtkSmartPointer<svtkUnicodeStringArray>::New();
    array4->InsertNextValue(svtkUnicodeString::from_utf8("array4_0"));
    array4->InsertNextValue(svtkUnicodeString::from_utf8("array4_1"));
    array4->InsertNextValue(svtkUnicodeString::from_utf8("array4_2"));

    svtkSmartPointer<svtkUnicodeStringArray> array5 = svtkSmartPointer<svtkUnicodeStringArray>::New();
    array5->InsertNextValue(svtkUnicodeString::from_utf8("array5_0"));
    array5->InsertNextValue(svtkUnicodeString::from_utf8("array5_1"));
    array5->InsertNextValue(svtkUnicodeString::from_utf8("array5_2"));
    array5->InsertNextValue(svtkUnicodeString::from_utf8("array5_3"));

    svtkSmartPointer<svtkIdList> interpIds = svtkSmartPointer<svtkIdList>::New();
...
int TestErrorsAndWarnings()
{
  ...
  array->AddObserver(svtkCommand::WarningEvent, errorObserver);
  ...
  svtkSmartPointer<svtkDoubleArray> doubleArray = svtkSmartPointer<svtkDoubleArray>::New();
  ...
  // Warning: Input and output array data types do not match.
  svtkSmartPointer<svtkIdList> id1 = svtkSmartPointer<svtkIdList>::New();
  ...
  svtkSmartPointer<svtkIdList> id2 = svtkSmartPointer<svtkIdList>::New();
