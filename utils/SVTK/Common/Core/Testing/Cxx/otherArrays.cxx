...
int doArrayTest(ostream& strm, T* ptr, A* array, V value, int size, bool svtkFree = false)
{
  ...
  strm << "\tSetVoidArray...";
  int svtkDeletesMemory = (svtkFree) ? 0 : 1;
  ptr->SetVoidArray(array, size, svtkDeletesMemory, svtkAbstractArray::SVTK_DATA_ARRAY_DELETE);
  strm << "OK" << endl;
  ...
  strm << "\tsvtkDataArray::GetTuple(i, double *tuple)...";
  static_cast<svtkDataArray*>(ptr)->GetTuple(4, tuple3);
  passed = 1;
  for (i = 0; i < 10; i++)
  {
    strm << tuple3[i] << " ";
  ...
  strm << "\tsvtkDataArray::GetData...";
  svtkDoubleArray* farray = svtkDoubleArray::New();
  farray->SetNumberOfComponents(1);
  ptr->svtkDataArray::GetData(0, 59, 1, 1, farray);
  passed = 1;
  for (i = 0; i < 10; i++)
  {
...
int otherArraysTest(ostream& strm)
{
  int errors = 0;
  {
    ...
    svtkCharArray* ptr = svtkCharArray::New();
...

  {
    ...
    svtkUnsignedCharArray* ptr = svtkUnsignedCharArray::New();
...

  {
    ...
    svtkIntArray* ptr = svtkIntArray::New();
...

  {
    ...
    svtkUnsignedIntArray* ptr = svtkUnsignedIntArray::New();
...

  {
    ...
    svtkLongArray* ptr = svtkLongArray::New();
...

  {
    ...
    svtkUnsignedLongArray* ptr = svtkUnsignedLongArray::New();
...

  {
    ...
    svtkShortArray* ptr = svtkShortArray::New();
...

  {
    ...
    svtkUnsignedShortArray* ptr = svtkUnsignedShortArray::New();
...

  {
    ...
    svtkFloatArray* ptr = svtkFloatArray::New();
...

  {
    ...
    svtkDoubleArray* ptr = svtkDoubleArray::New();
...

  {
    ...
    svtkIdTypeArray* ptr = svtkIdTypeArray::New();
    svtkIdType* array = new svtkIdType[SIZE];
    svtkIdType value = static_cast<svtkIdType>(1);
    for (int i = 0; i < SIZE; i++)
    {
      *(array + i) = static_cast<svtkIdType>(i);
    }
    errors += doArrayTest(strm, ptr, array, value, SIZE);
    ptr->Delete();
    delete[] array;
