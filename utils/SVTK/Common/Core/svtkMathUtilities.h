...
#ifndef svtkMathUtilities_h
#define svtkMathUtilities_h

#include <cmath>
#include <limits>

namespace svtkMathUtilities
{
...
{
  A absdiff = fabs(a - b);
  A d1 = svtkMathUtilities::SafeDivision<A>(absdiff, fabs(a));
  A d2 = svtkMathUtilities::SafeDivision<A>(absdiff, fabs(b));
  //@}
...
} // End svtkMathUtilities namespace.

#endif // svtkMathUtilities_h
// SVTK-HeaderTest-Exclude: svtkMathUtilities.h
