 ...
 *
 *
 * svtkUnicodeString provides storage for Unicode text.  Conceptually, it
 ...
 *
 * Note that, because svtkUnicodeString uses variable-length encodings for
...
#ifndef svtkUnicodeString_h
#define svtkUnicodeString_h
...
typedef svtkTypeUInt32 svtkUnicodeStringValueType;
...
// additional case for SVTK_UNICODE_STRING
#define svtkSuperExtraExtendedTemplateMacro(call)                                                   \
  svtkExtraExtendedTemplateMacro(call);                                                             \
  svtkTemplateMacroCase(SVTK_UNICODE_STRING, svtkUnicodeString, call)

class SVTKCOMMONCORE_EXPORT svtkUnicodeString
{
public:
  typedef svtkUnicodeStringValueType value_type;
  typedef std::string::size_type size_type;

  class SVTKCOMMONCORE_EXPORT const_iterator
  {
  public:
  ...
  private:
    ...
    friend class svtkUnicodeString;
   ...
   */
  std::vector<svtkTypeUInt16> utf16_str() const;
  /**
   * Inserts the sequence into the supplied storage as a collection of UTF-16 encoded
   * characters
   */
  void utf16_str(std::vector<svtkTypeUInt16>& result) const;
   ...
   */
  svtkUnicodeString& operator+=(value_type);
  /**
   * Append a Unicode sequence to the end of the current sequence.
   */
  svtkUnicodeString& operator+=(const svtkUnicodeString& rhs);
   ...
   */
  void append(const svtkUnicodeString& value);
   ...
   */
  void assign(const svtkUnicodeString& value);
   ...
   */
  svtkUnicodeString fold_case() const;
...
SVTKCOMMONCORE_EXPORT bool operator==(const svtkUnicodeString& lhs, const svtkUnicodeString& rhs);
SVTKCOMMONCORE_EXPORT bool operator!=(const svtkUnicodeString& lhs, const svtkUnicodeString& rhs);
SVTKCOMMONCORE_EXPORT bool operator<(const svtkUnicodeString& lhs, const svtkUnicodeString& rhs);
SVTKCOMMONCORE_EXPORT bool operator<=(const svtkUnicodeString& lhs, const svtkUnicodeString& rhs);
SVTKCOMMONCORE_EXPORT bool operator>=(const svtkUnicodeString& lhs, const svtkUnicodeString& rhs);
...
// SVTK-HeaderTest-Exclude: svtkUnicodeString.h
