...
void svtkLargeInteger::Contract()
{
...
svtkLargeInteger::svtkLargeInteger()
{
...
svtkLargeInteger::svtkLargeInteger(long long n)
{
...
svtkLargeInteger::svtkLargeInteger(unsigned long long n)
{
  this->Negative = 0;
  this->Number = new char[BIT_INCREMENT];
  for (unsigned int i = 0; i < BIT_INCREMENT; i++)
...
svtkLargeInteger::svtkLargeInteger(long n)
{
  this->Negative = n < 0 ? 1 : 0;
  n = n < 0 ? -n : n; // strip of sign
  this->Number = new char[BIT_INCREMENT];
...
svtkLargeInteger::svtkLargeInteger(unsigned long n)
{
  this->Negative = 0;
  this->Number = new char[BIT_INCREMENT];
  for (unsigned int i = 0; i < BIT_INCREMENT; i++)
...
svtkLargeInteger::svtkLargeInteger(unsigned int n)
{
  this->Negative = 0;
  this->Number = new char[BIT_INCREMENT];
  for (unsigned int i = 0; i < BIT_INCREMENT; i++)
...
svtkLargeInteger::svtkLargeInteger(int n)
{
  this->Negative = n < 0 ? 1 : 0;
  n = n < 0 ? -n : n; // strip of sign
  this->Number = new char[BIT_INCREMENT];
...
svtkLargeInteger::svtkLargeInteger(const svtkLargeInteger& n)
{
...
char svtkLargeInteger::CastToChar() const
{
  return this->CastToLong();
}

short svtkLargeInteger::CastToShort() const
{
  return this->CastToLong();
}

int svtkLargeInteger::CastToInt() const
{
  return this->CastToLong();
}

long svtkLargeInteger::CastToLong() const
{
  long n = 0;
...
unsigned long svtkLargeInteger::CastToUnsignedLong() const
{
  unsigned long n = 0;
...
int svtkLargeInteger::IsEven() const
{
  return this->Number[0] == 0;
}

int svtkLargeInteger::IsOdd() const
{
  return this->Number[0] == 1;
}

int svtkLargeInteger::GetLength() const
{
  return this->Sig + 1;
}

int svtkLargeInteger::GetBit(unsigned int p) const
{
...
int svtkLargeInteger::IsZero() const
{
  return (this->Sig == 0 && this->Number[0] == 0);
}

int svtkLargeInteger::GetSign() const
{
  return this->Negative;
}

void svtkLargeInteger::Truncate(unsigned int n)
{
...
void svtkLargeInteger::Complement()
{
...
bool svtkLargeInteger::operator==(const svtkLargeInteger& n) const
{
...
bool svtkLargeInteger::IsSmaller(const svtkLargeInteger& n) const
{
  if (this->Sig < n.Sig) // check size
  {
    return true;
...
bool svtkLargeInteger::IsGreater(const svtkLargeInteger& n) const
{
  if (this->Sig > n.Sig) // check size
  {
    return true;
...
void svtkLargeInteger::Expand(unsigned int n)
{
...
svtkLargeInteger& svtkLargeInteger::operator=(const svtkLargeInteger& n)
{
...
void svtkLargeInteger::Plus(const svtkLargeInteger& n)
{
...
void svtkLargeInteger::Minus(const svtkLargeInteger& n)
{
...
svtkLargeInteger& svtkLargeInteger::operator<<=(int n)
{
  int i;
...
svtkLargeInteger& svtkLargeInteger::operator++()
{
  return (*this += 1);
}
...
svtkLargeInteger svtkLargeInteger::operator++(int)
{
  svtkLargeInteger c = *this;
  *this += 1;
  return c;
}
...
svtkLargeInteger& svtkLargeInteger::operator/=(const svtkLargeInteger& n)
{
  ...
  {
    svtkGenericWarningMacro("Divide by zero!");
    return *this;
  }

  svtkLargeInteger c;
  svtkLargeInteger m = n;
  m <<= maximum(this->Sig - n.Sig, 0); // svtkpower of two multiple of n
  svtkLargeInteger i = 1;
  i = i << (this->Sig - n.Sig);
  for (; i > 0; i = i >> 1)
  {
    if (!m.IsGreater(*this))
...
svtkLargeInteger svtkLargeInteger::operator+(const svtkLargeInteger& n) const
{
  svtkLargeInteger c = *this;
  c += n;
  return c;
...
svtkLargeInteger svtkLargeInteger::operator<<(int n) const
{
  svtkLargeInteger c = *this;
  c <<= n;
  return c;
...
ostream& operator<<(ostream& s, const svtkLargeInteger& n)
{
  if (n.Negative)
  {
    s << '-';
...
istream& operator>>(istream& s, svtkLargeInteger& n)
{
  char c = 0;
