...
/**
 * @class   svtkIOStream
 * @brief   Include C++ iostreams as used by SVTK.
 *
 * This header includes the proper streams.
 */

#ifndef svtkIOStream_h
#define svtkIOStream_h
...
#endif // svtkIOStream_h
// SVTK-HeaderTest-Exclude: svtkIOStream.h
