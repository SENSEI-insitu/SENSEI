...
{
  // this case comes from a real-world example (see https://gitlab.kitware.com/svtk/svtk/issues/17170
  // )
#define NTRIANGLES 7

  svtkIdType tris[NTRIANGLES][3] = { { 0, 1, 2 }, { 3, 4, 7 }, { 7, 4, 5 }, { 4, 6, 5 }, { 3, 7, 4 },
    { 4, 7, 6 }, { 7, 5, 6 } };
