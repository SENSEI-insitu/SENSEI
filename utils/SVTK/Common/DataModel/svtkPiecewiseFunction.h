/*=========================================================================
  ...
  Module:    svtkPiecewiseFunction.h
...
#ifndef svtkPiecewiseFunction_h
#define svtkPiecewiseFunction_h
...
class SVTKCOMMONDATAMODEL_EXPORT svtkPiecewiseFunction : public svtkDataObject
{
public:
  static svtkPiecewiseFunction* New();
  svtkTypeMacro(svtkPiecewiseFunction, svtkDataObject);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  void DeepCopy(svtkDataObject* f) override;
  void ShallowCopy(svtkDataObject* f) override;

  /**
   * Return what type of dataset this is.
   */
  int GetDataObjectType() override { return SVTK_PIECEWISE_FUNCTION; }
   ...
   * note that the svtkPiecewiseFunction no longer stores the nodes
   ...
   */
  svtkGetVector2Macro(Range, double);
  //@}
   ...
   * @{
   */
  svtkSetMacro(UseLogScale, bool);
  svtkGetMacro(UseLogScale, bool);
  svtkBooleanMacro(UseLogScale, bool);
  /**@}*/
  ...
  /**
   * Clears out the current function. A newly created svtkPiecewiseFunction
   ...
   */
  static svtkPiecewiseFunction* GetData(svtkInformation* info);
  static svtkPiecewiseFunction* GetData(svtkInformationVector* v, int i = 0);
  //@}
...
protected:
  ...
  ~svtkPiecewiseFunction() override;
  ...
  svtkPiecewiseFunctionInternals* Internal;
...
private:
  svtkPiecewiseFunction(const svtkPiecewiseFunction&) = delete;
  void operator=(const svtkPiecewiseFunction&) = delete;
};
