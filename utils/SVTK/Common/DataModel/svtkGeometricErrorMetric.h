/*=========================================================================
  ...
  Module:    svtkGeometricErrorMetric.h
...
=========================================================================*/
/**
 * @class   svtkGeometricErrorMetric
...
#ifndef svtkGeometricErrorMetric_h
#define svtkGeometricErrorMetric_h
...
class SVTKCOMMONDATAMODEL_EXPORT svtkGeometricErrorMetric : public svtkGenericSubdivisionErrorMetric
{
public:
  /**
   ...
   * accuracy equal to 1.
   */
  static svtkGeometricErrorMetric* New();

  //@{
  /**
   * Standard SVTK type and error macros.
   */
  svtkTypeMacro(svtkGeometricErrorMetric, svtkGenericSubdivisionErrorMetric);
   ...
   */
  svtkGetMacro(AbsoluteGeometricTolerance, double);
  //@}
   ...
   * \pre ds_exists: ds!=0
   */
  void SetRelativeGeometricTolerance(double value, svtkGenericDataSet* ds);
...
protected:
  svtkGeometricErrorMetric();
  ~svtkGeometricErrorMetric() override;
...
private:
  svtkGeometricErrorMetric(const svtkGeometricErrorMetric&) = delete;
  void operator=(const svtkGeometricErrorMetric&) = delete;
};
