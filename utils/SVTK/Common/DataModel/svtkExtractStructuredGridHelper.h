 ...
 *
 *
 * svtkExtractStructuredGridHelper provides some common functionality that is
 ...
 *
 * @sa
 * svtkExtractGrid svtkExtractVOI svtkExtractRectilinearGrid
 */

#ifndef svtkExtractStructuredGridHelper_h
#define svtkExtractStructuredGridHelper_h
...
class SVTKCOMMONDATAMODEL_EXPORT svtkExtractStructuredGridHelper : public svtkObject
{
public:
  static svtkExtractStructuredGridHelper* New();
  svtkTypeMacro(svtkExtractStructuredGridHelper, svtkObject);
   ...
   * \pre outPD != nullptr.
   */
  void CopyPointsAndPointData(int inExt[6], int outExt[6], svtkPointData* pd, svtkPoints* inpnts,
    svtkPointData* outPD, svtkPoints* outpnts);
   ...
   * \pre outCD != nullptr.
   */
  void CopyCellData(int inExt[6], int outExt[6], svtkCellData* cd, svtkCellData* outCD);
...
protected:
  svtkExtractStructuredGridHelper();
  ~svtkExtractStructuredGridHelper() override;
  ...
  svtk::detail::svtkIndexMap* IndexMap;
...
private:
  svtkExtractStructuredGridHelper(const svtkExtractStructuredGridHelper&) = delete;
  void operator=(const svtkExtractStructuredGridHelper&) = delete;
};

#endif /* SVTKEXTRACTSTRUCTUREDGRIDHELPER_H_ */
