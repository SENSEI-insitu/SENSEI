...
Module:    svtkHyperTreeGridNonOrientedMooreSuperCursorLight.cxx
...
svtkStandardNewMacro(svtkHyperTreeGridNonOrientedMooreSuperCursorLight);

#include "svtkHyperTreeGridNonOrientedMooreSuperCursorData.cxx"

//-----------------------------------------------------------------------------
void svtkHyperTreeGridNonOrientedMooreSuperCursorLight::Initialize(
...
//-----------------------------------------------------------------------------
bool svtkHyperTreeGridNonOrientedMooreSuperCursorLight::GetCornerCursors(
  unsigned int c, unsigned int l, svtkIdList* leaves)
{
  ...
  {
    svtkHyperTreeGridLevelEntry& cursor = this->Entries[this->GetIndiceEntry(cursorIdx)];
...
//-----------------------------------------------------------------------------
void svtkHyperTreeGridNonOrientedMooreSuperCursorLight::PrintSelf(ostream& os, svtkIndent indent)
{
  os << indent << "--svtkHyperTreeGridNonOrientedMooreSuperCursorLight--" << endl;
  svtkHyperTreeGridNonOrientedSuperCursorLight::PrintSelf(os, indent);
}
