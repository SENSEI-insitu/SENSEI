/*=========================================================================
  ...
  Module:    svtkStaticEdgeLocatorTemplate.txx
...
#ifndef svtkStaticEdgeLocatorTemplate_txx
#define svtkStaticEdgeLocatorTemplate_txx

//----------------------------------------------------------------------------
// Gather coincident edges into contiguous runs. Use this for merging edges.
template <typename IDType, typename EdgeData>
const IDType* svtkStaticEdgeLocatorTemplate<IDType, EdgeData>::MergeEdges(
  svtkIdType numEdges, MergeTupleType* mergeArray, svtkIdType& numUniqueEdges)
{
  ...
  svtkSMPTools::Sort(this->MergeArray, this->MergeArray + numEdges);
  ...
  numUniqueEdges = static_cast<svtkIdType>(this->MergeOffsets.size());
...
template <typename IDType, typename EdgeData>
svtkIdType svtkStaticEdgeLocatorTemplate<IDType, EdgeData>::BuildLocator(
  svtkIdType numEdges, EdgeTupleType* edgeArray)
{
  // Sort the edges. Note that the sort is first on V0, then V1. So both
  // V0 and V1 are sorted in ascending order.
  this->EdgeArray = edgeArray;
  svtkSMPTools::Sort(this->EdgeArray, this->EdgeArray + numEdges);
