...
if not CheckCell(c, CheckTetra):
    print("Failure for svtkTetra")
    sys.exit(1)

c = svtkQuadraticTetra()
c.Initialize(10, pts)
if not CheckCell(c, CheckTetra):
    print("Failure for svtkQuadraticTetra")
    sys.exit(1)
...
if not CheckCell(c, CheckHex):
    print("Failure for svtkHexahedron")
    sys.exit(1)

c = svtkQuadraticHexahedron()
c.Initialize(20, pts)
if not CheckCell(c, CheckHex):
    print("Failure for svtkQuadraticHexahedron")
    sys.exit(1)
...
if not CheckCell(c, CheckPyramid):
    print("Failure for svtkPyramid")
    sys.exit(1)

c = svtkQuadraticPyramid()
c.Initialize(13, pts)
if not CheckCell(c, CheckPyramid):
    print("Failure for svtkQuadraticPyramid")
    sys.exit(1)
...
if not CheckCell(c, CheckWedge):
    print("Failure for svtkWedge")
    sys.exit(1)

c = svtkQuadraticWedge()
c.Initialize(15, pts)
if not CheckCell(c, CheckWedge):
    print("Failure for svtkQuadraticWedge")
    sys.exit(1)
