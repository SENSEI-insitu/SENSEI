...
{
  svtkSmartPointer<svtkPoints> polyhedronPoints = svtkSmartPointer<svtkPoints>::New();

  svtkSmartPointer<svtkCellArray> polyhedronFaces = svtkSmartPointer<svtkCellArray>::New();

  std::vector<svtkIdType> polyhedronPointsIds;
  ...
  if (shape == dodecahedron)
  {
    ...
    svtkIdType dodechedronFace[nFaces][5] = {
      { 0, 1, 2, 3, 4 },
      { 0, 5, 10, 6, 1 },
      { 1, 6, 11, 7, 2 },
      { 2, 7, 12, 8, 3 },
  ...
  else if (shape == u_shape)
  {
    ...
    svtkIdType f1[8] = { 0, 1, 2, 3, 4, 5, 6, 7 };
    svtkIdType f2[8] = { 15, 14, 13, 12, 11, 10, 9, 8 };
    svtkIdType f3[4] = { 0, 7, 15, 8 };
    svtkIdType f4[4] = { 1, 0, 8, 9 };
    svtkIdType f5[4] = { 2, 1, 9, 10 };
    svtkIdType f6[4] = { 3, 2, 10, 11 };
    svtkIdType f7[4] = { 4, 3, 11, 12 };
    svtkIdType f8[4] = { 5, 4, 12, 13 };
    svtkIdType f9[4] = { 6, 5, 13, 14 };
    svtkIdType f10[4] = { 7, 6, 14, 15 };

    svtkIdType* concaveShapeFace[nFaces] = { f1, f2, f3, f4, f5, f6, f7, f8, f9, f10 };
  ...
  else if (shape == cube)
  {
    ...
    svtkIdType f1[4] = { 0, 1, 2, 3 };
    svtkIdType f2[4] = { 7, 6, 5, 4 };
    svtkIdType f3[4] = { 0, 3, 7, 4 };
    svtkIdType f4[4] = { 5, 1, 0, 4 };
    svtkIdType f5[4] = { 6, 2, 1, 5 };
    svtkIdType f6[4] = { 7, 3, 2, 6 };

    svtkIdType* cubeShapeFace[nFaces] = { f1, f2, f3, f4, f5, f6 };
  ...
  else if (shape == colinear_cube)
  {
    ...
    svtkIdType f1[5] = { 0, 1, 2, 3, 4 };
    svtkIdType f2[5] = { 9, 8, 7, 6, 5 };
    svtkIdType f3[4] = { 0, 4, 9, 5 };
    svtkIdType f4[4] = { 7, 2, 1, 6 };
    svtkIdType f5[4] = { 5, 6, 1, 0 };
    svtkIdType f6[4] = { 8, 3, 2, 7 };
    svtkIdType f7[4] = { 9, 4, 3, 8 };

    svtkIdType* cubeShapeFace[nFaces] = { f1, f2, f3, f4, f5, f6, f7 };
  ...
  else if (shape == convex_pyramid)
  {
    ...
    svtkIdType f1[4] = { 0, 1, 2, 3 };
    svtkIdType f2[3] = { 0, 4, 1 };
    svtkIdType f3[3] = { 1, 4, 2 };
    svtkIdType f4[3] = { 2, 4, 3 };
    svtkIdType f5[3] = { 3, 4, 0 };

    svtkIdType* pyramidShapeFace[nFaces] = { f1, f2, f3, f4, f5 };
  ...
  ugrid->InsertNextCell(SVTK_POLYHEDRON, polyhedronPoints->GetNumberOfPoints(),
