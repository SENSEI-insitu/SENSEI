...
// .NAME
// .SECTION Description
// This program tests functions in svtkGraph
...
int TestGetEdgeId()
{
  ...
  svtkEdgeType e0 = g->AddEdge(v0, v1);
  svtkEdgeType e1 = g->AddEdge(v1, v2);
...
int TestToDirectedGraph()
{
  ...
  svtkSmartPointer<svtkMutableUndirectedGraph> ug = svtkSmartPointer<svtkMutableUndirectedGraph>::New();
  svtkIdType v0 = ug->AddVertex();
  svtkIdType v1 = ug->AddVertex();
  svtkIdType v2 = ug->AddVertex();

  ug->AddEdge(v0, v1);
  ug->AddEdge(v1, v2);

  // Convert it to a directed graph
  svtkSmartPointer<svtkMutableDirectedGraph> dg = svtkSmartPointer<svtkMutableDirectedGraph>::New();
...
int TestToUndirectedGraph()
{
  ...
  svtkSmartPointer<svtkMutableDirectedGraph> dg = svtkSmartPointer<svtkMutableDirectedGraph>::New();
  svtkIdType v0 = dg->AddVertex();
  svtkIdType v1 = dg->AddVertex();
  svtkIdType v2 = dg->AddVertex();
