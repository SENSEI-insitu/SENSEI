...
void GenerateIntersectingLineSegments(svtkMinimalStandardRandomSequence* seq, double* a1, double* a2,
...
void RandomSphere(
  svtkMinimalStandardRandomSequence* seq, const double radius, const double* offset, double* value)
{
...
void GenerateNonintersectingLineSegments(
  svtkMinimalStandardRandomSequence* seq, double* a1, double* a2, double* b1, double* b2)
{
...
void GenerateLinesAtKnownDistance(svtkMinimalStandardRandomSequence* seq, double& lineDist,
...
void GenerateLineAtKnownDistance(
  svtkMinimalStandardRandomSequence* seq, double* a1, double* a2, double* p, double& dist)
{
...
double PointToLineSegment(double* p1, double* p2, double* p, double* pn, double& u)
{
  ...
  // It is not used to actually test the svtkLine function for the same purpose,
...
void GenerateLineSegmentsAtKnownDistance(svtkMinimalStandardRandomSequence* seq, double& lineDist,
  double* a1, double* a2, double* b1, double* b2, double* a12, double* b12, double& u, double& v)
{
...
int TestLineIntersection_PositiveResult(svtkMinimalStandardRandomSequence* seq, unsigned nTests)
{
  ...
  for (unsigned i = 0; i < nTests; i++)
  {
    ...
    double uv[2];
    int returnValue = svtkLine::Intersection3D(a1, a2, b1, b2, uv[0], uv[1]);
...
int TestLineIntersection_NegativeResult(svtkMinimalStandardRandomSequence* seq, unsigned nTests)
{
  double a1[3], a2[3], b1[3], b2[3], u, v;
  ...
  for (unsigned i = 0; i < nTests; i++)
  {
    ...
    int returnValue = svtkLine::Intersection3D(a1, a2, b1, b2, u, v);
...
int TestLineIntersection_ColinearResult(svtkMinimalStandardRandomSequence* seq, unsigned nTests)
{
  double a1[3], a2[3], b1[3], b2[3], u, v;
...
int TestLineIntersection(svtkMinimalStandardRandomSequence* seq, unsigned nTests)
{
...
int TestDistanceBetweenLines(svtkMinimalStandardRandomSequence* seq, unsigned nTests)
{
  ...
  for (unsigned i = 0; i < nTests; i++)
  {
    ...
    double d = svtkLine::DistanceBetweenLines(a1, a2, b1, b2, p1, p2, t1, t2);
...
int TestDistanceBetweenLineSegments(svtkMinimalStandardRandomSequence* seq, unsigned nTests)
{
  double a1[3], a2[3], b1[3], b2[3], a12[3], b12[3], u, v, dist;
  ...
  for (unsigned i = 0; i < nTests; i++)
  {
    ...
    double p1[3], p2[3], t1, t2;
    double d = svtkLine::DistanceBetweenLineSegments(a1, a2, b1, b2, p1, p2, t1, t2);
...
int TestDistanceToLine(svtkMinimalStandardRandomSequence* seq, unsigned nTests)
{
  ...
  for (unsigned i = 0; i < nTests; i++)
  {
    ...
    double d = svtkLine::DistanceToLine(p, a1, a2);
...
int UnitTestLine(int, char*[])
{
  ...
  std::cout << "Testing svtkLine::svtkLine::Intersection3D" << std::endl;
  if (TestLineIntersection(sequence, nTest) == EXIT_FAILURE)
  {
    return EXIT_FAILURE;
  }
  std::cout << "Testing svtkLine::DistanceBetweenLines" << std::endl;
  if (TestDistanceBetweenLines(sequence, nTest) == EXIT_FAILURE)
  {
    return EXIT_FAILURE;
  }
  std::cout << "Testing svtkLine::DistanceBetweenLineSegments" << std::endl;
  if (TestDistanceBetweenLineSegments(sequence, nTest) == EXIT_FAILURE)
  {
    return EXIT_FAILURE;
  }
  std::cout << "Testing svtkLine::DistanceToLine" << std::endl;
