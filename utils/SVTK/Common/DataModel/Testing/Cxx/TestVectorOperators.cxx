...
int TestVectorOperators(int, char*[])
{
  ...
  // Test out svtkVector3i and ensure the ostream operator is working.
  cout << "vec3i -> " << vec3i << endl;

  // Test the equality operator.
  svtkVector3i vec3ia(0, 6, 9);
  svtkVector3i vec3ib(0, 6, 8);
  svtkVector<int, 3> vector3f(vec3i.GetData());
  ...
  svtkVector3i result = vec3ia + vec3ib;
  if (result != svtkVector3i(0, 12, 17))
  {
  ...
  // Test the * operator.
  result = vec3ia * vec3ib;
  if (result != svtkVector3i(0, 36, 72))
  {
  ...
  result = vec3ia * 2;
  if (result != svtkVector3i(0, 12, 18))
  {
