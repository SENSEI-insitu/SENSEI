...
int TestOCB(ostream& strm)
{
  ...
  int i, j, k;
  strm << "Test svtkCell::CellBoundary Start" << endl;
  ...
  for (j = 0; j < 1; j++)
  {
    ...
    strm << "svtkVertex \t(" << vertexCoords[j][0] << ") \t= ";
  ...
  for (k = 0; k < polyVertex->GetPointIds()->GetNumberOfIds(); k++)
  {
    for (j = 0; j < 1; j++)
    {
      ...
      strm << "svtkPolyVertex \t(" << polyVertexCoords[j][0] << ") \t= ";
      for (i = 0; i < ids->GetNumberOfIds(); i++)
      {
        strm << ids->GetId(i) << ", ";
      }
  ...
  for (k = 0; k < polyLine->GetPointIds()->GetNumberOfIds() - 1; k++)
  {
    for (j = 0; j < 2; j++)
    {
      ...
      strm << "svtkPolyLine \t(" << polyLineCoords[j][0] << ") = \t";
      for (i = 0; i < ids->GetNumberOfIds(); i++)
      {
        strm << ids->GetId(i) << ", ";
      }
  ...
  for (j = 0; j < 3; j++)
  {
    ...
    strm << "svtkTriangle \t(" << triangleCoords[j][0] << ", " << triangleCoords[j][1] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
    }
  ...
  for (k = 0; k < triangleStrip->GetPointIds()->GetNumberOfIds() - 2; k++)
  {
    for (j = 0; j < 3; j++)
    {
      ...
      strm << "svtkTriangleStrip \t(" << triangleStripCoords[j][0] << ", "
  ...
  for (j = 0; j < 4; j++)
  {
    ...
    strm << "svtkQuad \t(" << quadCoords[j][0] << ", " << quadCoords[j][1] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
    }
  ...
  for (j = 0; j < 4; j++)
  {
    ...
    strm << "svtkPixel \t(" << pixelCoords[j][0] << ", " << pixelCoords[j][1] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
    }
  ...
  for (j = 0; j < 4; j++)
  {
    ...
    strm << "svtkPolygon \t(" << polygonCoords[j][0] << ", " << polygonCoords[j][1] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
    }
  ...
  for (j = 0; j < 4; j++)
  {
    ...
    strm << "svtkTetra \t(" << tetraCoords[j][0] << ", " << tetraCoords[j][1] << ", "
         << tetraCoords[j][2] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
  ...
  for (j = 0; j < 6; j++)
  {
    ...
    strm << "svtkVoxel \t(" << voxelCoords[j][0] << ", " << voxelCoords[j][1] << ", "
         << voxelCoords[j][2] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
  ...
  for (j = 0; j < 6; j++)
  {
    ...
    strm << "svtkWedge \t(" << wedgeCoords[j][0] << ", " << wedgeCoords[j][1] << ", "
         << wedgeCoords[j][2] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
  ...
  for (j = 0; j < 8; j++)
  {
    ...
    strm << "svtkHexahedron \t(" << hexahedronCoords[j][0] << ", " << hexahedronCoords[j][1] << ", "
  ...
  for (j = 0; j < 10; j++)
  {
    ...
    strm << "svtkPentagonalPrism \t(" << pentaCoords[j][0] << ", " << pentaCoords[j][1] << ", "
         << pentaCoords[j][2] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
  ...
  for (j = 0; j < 12; j++)
  {
    ...
    strm << "svtkHexagonalPrism \t(" << hexaCoords[j][0] << ", " << hexaCoords[j][1] << ", "
         << hexaCoords[j][2] << ") = \t";
    for (i = 0; i < ids->GetNumberOfIds(); i++)
    {
      strm << ids->GetId(i) << ", ";
  ...
  strm << "Test svtkCell::CellBoundary Complete" << endl;
...
int otherCellBoundaries(int, char*[])
{
  ...
  return TestOCB(svtkmsg_with_warning_C4701);
}
