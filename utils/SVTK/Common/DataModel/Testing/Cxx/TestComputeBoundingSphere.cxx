...
int TestComputeBoundingSphere(int, char*[])
{
...

  {
    ...
    float sphere[4];
    svtkSphere::ComputeBoundingSphere(points, 0, sphere, nullptr);
...

  {
    ...
    {
      double x = svtkMath::Random(-100.0, 100.0);
      double y = svtkMath::Random(-10.0, 10.0);
      double z = svtkMath::Random(-1.0, 1.0);
      doublePoints.push_back(x);
      doublePoints.push_back(y);
      doublePoints.push_back(z);
    }
    double sphere[4];
    svtkSphere::ComputeBoundingSphere(&(*doublePoints.begin()), 1, sphere, nullptr);
...

  {
    ...
    double sphere[4];
    svtkSphere::ComputeBoundingSphere(&(*doublePoints.begin()), numberOfPoints, sphere, nullptr);
...

  {
    ...
    {
      float x = svtkMath::Random(-100.0, 100.0);
      float y = svtkMath::Random(-100.0, 100.0);
      float z = svtkMath::Random(-100.0, 100.0);
    ...
    float sphere[4];
    svtkSphere::ComputeBoundingSphere(&(*floatPoints.begin()), numberOfPoints, sphere, hint);
    std::cout << "sphere: " << sphere[0] << ", " << sphere[1] << ", " << sphere[2] << ": "
              << sphere[3] << " ";
    std::cout << "Passed" << std::endl;
  }
...

  {
    ...
    float sphere[4];
    svtkSphere::ComputeBoundingSphere(spheres, 0, sphere, nullptr);
    if (sphere[0] == 0.0 && sphere[1] == 0.0 && sphere[2] == 0.0 && sphere[3] == 0.0)
    {
      std::cout << "Passed" << std::endl;
    }
...

  {
    ...
    for (size_t i = 0; i < 1; ++i)
    {
      ...
      xyzr[0] = svtkMath::Random(-100.0, 100.0);
      xyzr[1] = svtkMath::Random(-100.0, 100.0);
      xyzr[2] = svtkMath::Random(-100.0, 100.0);
      xyzr[3] = svtkMath::Random(1.0, 2.0);
    ...
    float sphere[4];
    svtkSphere::ComputeBoundingSphere(&floatSpheres[0], 1, sphere, nullptr);
...

  {
    ...
    float sphere[4];
    svtkSphere::ComputeBoundingSphere(&floatSpheres[0], numberOfSpheres, sphere, hint);
    std::cout << "sphere: " << sphere[0] << ", " << sphere[1] << ", " << sphere[2] << ": "
              << sphere[3] << " ";
    std::cout << "Passed" << std::endl;
  }

  {
    ...
    double sphere[4];
    svtkSphere::ComputeBoundingSphere(&doubleSpheres[0], numberOfSpheres, sphere, nullptr);
    std::cout << "sphere: " << sphere[0] << ", " << sphere[1] << ", " << sphere[2] << ": "
              << sphere[3] << " ";
    std::cout << "Passed" << std::endl;
  }
