...
// The legacy methods in svtkCellArray have been soft-deprecated with a comment
...
#define TEST_ASSERT(cond)                                                                          \
  ...
  {                                                                                                \
    if (!(cond))                                                                                   \
    {                                                                                              \
      ThrowAssertError(svtkQuoteMacro(__FILE__) ":" svtkQuoteMacro(                                  \
        __LINE__) ": test assertion failed: (" #cond ")");                                         \
    }                                                                                              \
  } while (false)

svtkSmartPointer<svtkCellArray> NewCellArray(bool use64BitStorage)
{
  auto cellArray = svtkSmartPointer<svtkCellArray>::New();
  if (use64BitStorage)
  {
...
void FillCellArray(svtkCellArray* cellArray)
{
...
void ValidateCellArray(svtkCellArray* cellArray)
{
  svtkIdType npts;
  const svtkIdType* pts;
  auto it = svtk::TakeSmartPointer(cellArray->NewIterator());
  it->GoToFirstCell();
...
void TestAllocate(svtkSmartPointer<svtkCellArray> cellArray)
{
...
void TestResize(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestInitialize(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestSqueeze(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  auto validate = [&](const svtkIdType cellId, const std::initializer_list<svtkIdType>& ref) {
    svtkIdType npts;
    const svtkIdType* pts;
...
void TestReset(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestIsValid(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetNumberOfCells(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetNumberOfOffsets(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetNumberOfConnectivityIds(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestNewIterator(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestSetDataImpl(svtkSmartPointer<svtkCellArray> cellArray, bool checkNoCopy)
{
  using ValueType = typename ArrayType::ValueType;

  svtkNew<svtkCellArray> test;
  test->DeepCopy(cellArray); // copy config settings

  svtkNew<ArrayType> offsets;
  svtkNew<ArrayType> conn;
...
void TestSetData(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);

  // These are documented to not deep copy the input arrays.
  TestSetDataImpl<svtkCellArray::ArrayType32>(cellArray, true);
  TestSetDataImpl<svtkCellArray::ArrayType64>(cellArray, true);
  TestSetDataImpl<svtkIdTypeArray>(cellArray, true);

  // These should work, but may deep copy:
  TestSetDataImpl<svtkTypeInt32Array>(cellArray, false);
  TestSetDataImpl<svtkTypeInt64Array>(cellArray, false);
  TestSetDataImpl<svtkIntArray>(cellArray, false);
  TestSetDataImpl<svtkLongArray>(cellArray, false);
  TestSetDataImpl<svtkLongLongArray>(cellArray, false);
}
...
void TestIsStorage64Bit(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestUse32BitStorage(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestUse64BitStorage(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestUseDefaultStorage(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  TEST_ASSERT(cellArray->IsStorage64Bit() == (sizeof(svtkIdType) == 8));
  TEST_ASSERT(cellArray->GetNumberOfOffsets() == 1);
  TEST_ASSERT(cellArray->GetNumberOfConnectivityIds() == 0);
}

void TestCanConvertTo32BitStorage(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  {
    cellArray->InsertNextCell({ 0, SVTK_TYPE_INT32_MAX });
    TEST_ASSERT(cellArray->CanConvertTo32BitStorage());

#ifdef SVTK_USE_64BIT_IDS
    cellArray->InsertNextCell({ 0, static_cast<svtkTypeInt64>(SVTK_TYPE_INT32_MAX) + 1 });
    TEST_ASSERT(!cellArray->CanConvertTo32BitStorage());
...
void TestCanConvertTo64BitStorage(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  if (cellArray->IsStorage64Bit())
  {
    ...
    cellArray->InsertNextCell({ 0, static_cast<svtkTypeInt64>(SVTK_TYPE_INT32_MAX) + 1 });
    TEST_ASSERT(cellArray->CanConvertTo64BitStorage());
    cellArray->InsertNextCell({ 0, SVTK_TYPE_INT64_MAX });
    TEST_ASSERT(cellArray->CanConvertTo64BitStorage());
...
void TestConvertTo32BitStorage(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestConvertTo64BitStorage(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetOffsetsArray(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetConnectivityArray(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestIsHomogeneous(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestTraversalSizePointer(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  auto validate = [&](const std::initializer_list<svtkIdType>& ref) {
    svtkIdType npts;
    const svtkIdType* pts;
...
void TestTraversalIdList(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetCellAtId(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetCellSize(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestInsertNextCell(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestIncrementalCellInsertion(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestReverseCellAtId(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestReplaceCellAtId(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestGetMaxCellSize(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestDeepCopy(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);

  FillCellArray(cellArray);

  svtkNew<svtkCellArray> other;
...
void TestShallowCopy(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestAppendImpl(svtkSmartPointer<svtkCellArray> first, svtkSmartPointer<svtkCellArray> second)
{
...
void TestAppend32(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  TestAppendImpl(cellArray, NewCellArray(false));
}

void TestAppend64(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  TestAppendImpl(cellArray, NewCellArray(true));
}

void TestLegacyFormatImportExportAppend(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  {
    std::vector<svtkIdType> expected{ 3, 0, 2, 3, 4, 1, 4, 5, 7, 5, 2, 8, 9, 1, 4, 2, 3, 7 };
    auto legacyRange = svtk::DataArrayValueRange<1>(legacy);
...
void TestLegacyAllocate(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);

  // Assumes triangles:
  const svtkIdType numTri = 1024;
...
void TestLegacyEstimateSize(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestLegacyGetSize(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestLegacyGetNumberOfConnectivityEntries(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestLegacyGetCell(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  auto validate = [&](const svtkIdType loc, const std::initializer_list<svtkIdType>& ref) {
    svtkIdType npts;
    const svtkIdType* pts;
...
void TestLegacyGetInsertLocation(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestLegacyGetSetTraversalLocation(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestLegacyReverseCell(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestLegacyReplaceCell(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
void TestLegacyGetData(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
  ...
  svtkIdTypeArray* legacy = cellArray->GetData();
...
void TestLegacySetCells(svtkSmartPointer<svtkCellArray> cellArray)
{
  svtkLogScopeFunction(INFO);
...
{
  svtkLogScopeF(INFO, "Testing %d-bit storage.", use64BitStorage ? 64 : 32);
