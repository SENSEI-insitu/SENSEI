...
static void ComputeDataValues(svtkPoints* pts, double* edgeValues);

void ComputeDataValues(svtkPoints* pts, double* edgeValues)
{
  double x[3];
...
int TestQE(ostream& strm)
{
  ...
  //-------------------------------------------------------------
  strm << "Test svtkCell::EvaluatePosition Start" << endl;
  ...
  strm << "Test svtkCell::EvaluatePosition End" << endl;

  //-------------------------------------------------------------
  strm << "Test svtkCell::EvaluateLocation Start" << endl;
  // svtkQuadraticEdge
  ...
  strm << "Test svtkCell::EvaluateLocation End" << endl;

  //-------------------------------------------------------------
  strm << "Test svtkCell::CellDerivs Start" << endl;

  // svtkQuadraticEdge - temporarily commented out
  ...
  strm << "Test svtkCell::CellDerivs End" << endl;
...
int quadraticEvaluation(int, char*[])
{
  ...
  return TestQE(svtkmsg_with_warning_C4701);
}
