...
int TestAngularPeriodicDataArray(int, char*[])
{
  ...
  svtkNew<svtkAngularPeriodicDataArray<double> > angularPeriodicDataArray;
  svtkNew<svtkAngularPeriodicDataArray<float> > angularPeriodicDataArray2;
  ...
  angularPeriodicDataArray2->SetAxis(SVTK_PERIODIC_ARRAY_AXIS_Y);
  ...
  {
    cerr.precision(20);
    cerr << "Error in svtkAngularPeriodicDataArray : " << endl
         << "Double Array : " << endl
  ...
  svtkNew<svtkDoubleArray> tensorArray;
  svtkNew<svtkAngularPeriodicDataArray<double> > tensorPArray;
  ...
  tensorPArray->SetAxis(SVTK_PERIODIC_ARRAY_AXIS_Z);
  ...
  svtkNew<svtkDoubleArray> symTensorArray;
  svtkNew<svtkAngularPeriodicDataArray<double> > symTensorPArray;
  ...
  symTensorPArray->SetAxis(SVTK_PERIODIC_ARRAY_AXIS_Y);
