...
{
  int i, j, k;
  svtkColorTransferFunction* ctf1 = svtkColorTransferFunction::New();

  // actual test
  strm << "Test svtkColorTransferFunction Start" << endl;
  ...
  svtkColorTransferFunction* ctf2 = svtkColorTransferFunction::New();
  ...
  for (k = 1; k <= 4; k++)
  {
    ctf2->MapScalarsThroughTable2((void*)cData, ucResult, SVTK_CHAR, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)ucData, ucResult, SVTK_UNSIGNED_CHAR, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)sData, ucResult, SVTK_SHORT, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)usData, ucResult, SVTK_UNSIGNED_SHORT, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)iData, ucResult, SVTK_INT, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)uiData, ucResult, SVTK_UNSIGNED_INT, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)lData, ucResult, SVTK_LONG, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)ulData, ucResult, SVTK_UNSIGNED_LONG, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)fData, ucResult, SVTK_FLOAT, 128, 1, k);
    ctf2->MapScalarsThroughTable2((void*)dData, ucResult, SVTK_DOUBLE, 128, 1, k);
  }
  ...
  strm << "Test svtkColorTransferFunction End" << endl;
  return 0;
}
