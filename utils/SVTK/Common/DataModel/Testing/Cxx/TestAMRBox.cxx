...
void Construct2DAMRBox(svtkAMRBox& box, int lo[3], int hi[3])
{
  box.SetDimensions(lo, hi, SVTK_XY_PLANE);
}

//------------------------------------------------------------------------------
void Construct3DAMRBox(svtkAMRBox& box, int lo[3], int hi[3])
{
  box.SetDimensions(lo, hi, SVTK_XYZ_GRID);
}
...
int TestAMRBoxSerialization()
{
  ...
  svtkIdType expectedByteSize = svtkAMRBox::GetBytesize();
