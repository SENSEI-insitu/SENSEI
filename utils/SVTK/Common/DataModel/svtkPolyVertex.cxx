...
svtkStandardNewMacro(svtkPolyVertex);

//----------------------------------------------------------------------------
svtkPolyVertex::svtkPolyVertex()
{
...
//----------------------------------------------------------------------------
int svtkPolyVertex::EvaluatePosition(const double x[3], double closestPoint[3], int& subId,
...
//----------------------------------------------------------------------------
void svtkPolyVertex::EvaluateLocation(
  int& subId, const double svtkNotUsed(pcoords)[3], double x[3], double* weights)
{
  int i;
...
//----------------------------------------------------------------------------
int svtkPolyVertex::CellBoundary(int subId, const double pcoords[3], svtkIdList* pts)
{
...
//----------------------------------------------------------------------------
void svtkPolyVertex::Contour(double value, svtkDataArray* cellScalars,
...
//
int svtkPolyVertex::IntersectWithLine(const double p1[3], const double p2[3], double tol, double& t,
...
//----------------------------------------------------------------------------
int svtkPolyVertex::Triangulate(int svtkNotUsed(index), svtkIdList* ptIds, svtkPoints* pts)
{
  int subId;
...
//----------------------------------------------------------------------------
void svtkPolyVertex::Derivatives(int svtkNotUsed(subId), const double svtkNotUsed(pcoords)[3],
...
//----------------------------------------------------------------------------
void svtkPolyVertex::Clip(double value, svtkDataArray* cellScalars,
  svtkIncrementalPointLocator* locator, svtkCellArray* verts, svtkPointData* inPd, svtkPointData* outPd,
...
int svtkPolyVertex::GetParametricCenter(double pcoords[3])
{
...
//----------------------------------------------------------------------------
void svtkPolyVertex::PrintSelf(ostream& os, svtkIndent indent)
{
