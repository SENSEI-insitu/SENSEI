/*=========================================================================
  ...
  Module:    svtkLagrangeTriangle.cxx
...
svtkStandardNewMacro(svtkLagrangeTriangle);
//----------------------------------------------------------------------------
svtkLagrangeTriangle::svtkLagrangeTriangle()
  : svtkHigherOrderTriangle()
{
}

//----------------------------------------------------------------------------
svtkLagrangeTriangle::~svtkLagrangeTriangle() = default;

void svtkLagrangeTriangle::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

svtkCell* svtkLagrangeTriangle::GetEdge(int edgeId)
{
...
//----------------------------------------------------------------------------
void svtkLagrangeTriangle::InterpolateFunctions(const double pcoords[3], double* weights)
{
...
//----------------------------------------------------------------------------
void svtkLagrangeTriangle::InterpolateDerivs(const double pcoords[3], double* derivs)
{
...
svtkHigherOrderCurve* svtkLagrangeTriangle::getEdgeCell()
{
  return EdgeCell;
}
