/*=========================================================================
  ...
  Module:    svtkOrderedTriangulator.h
 ...
 * svtkPolygon::Triangulate(), svtkDelaunay2D, or svtkDelaunay3D.
 *
 * @par Background:
 ...
 * 3D cell faces. (See svtkClipVolume for an example.)
 *
 * @par Background:
 ...
 *
 * @sa
 * svtkDelaunay2D svtkDelaunay3D svtkPolygon
 */

#ifndef svtkOrderedTriangulator_h
#define svtkOrderedTriangulator_h
...
class SVTKCOMMONDATAMODEL_EXPORT svtkOrderedTriangulator : public svtkObject
{
public:
  svtkTypeMacro(svtkOrderedTriangulator, svtkObject);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Construct object.
   */
  static svtkOrderedTriangulator* New();
   ...
   */
  svtkIdType InsertPoint(svtkIdType id, double x[3], double p[3], int type);
  svtkIdType InsertPoint(svtkIdType id, svtkIdType sortid, double x[3], double p[3], int type);
  svtkIdType InsertPoint(
   ...
   */
  void UpdatePointType(svtkIdType internalId, int type);
   ...
   * \pre valid_range: internalId>=0 && internalId<this->GetNumberOfPoints()
   */
  double* GetPointPosition(svtkIdType internalId);
   ...
   * \pre valid_range: internalId>=0 && internalId<this->GetNumberOfPoints()
   */
  double* GetPointLocation(svtkIdType internalId);
   ...
   * \pre valid_range: internalId>=0 && internalId<this->GetNumberOfPoints()
   */
  svtkIdType GetPointId(svtkIdType internalId);
   ...
   */
  svtkSetMacro(UseTemplates, svtkTypeBool);
  svtkGetMacro(UseTemplates, svtkTypeBool);
  svtkBooleanMacro(UseTemplates, svtkTypeBool);
  //@}
   ...
   * InsertPoint().)
   */
  svtkSetMacro(PreSorted, svtkTypeBool);
  svtkGetMacro(PreSorted, svtkTypeBool);
  svtkBooleanMacro(PreSorted, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(UseTwoSortIds, svtkTypeBool);
  svtkGetMacro(UseTwoSortIds, svtkTypeBool);
  svtkBooleanMacro(UseTwoSortIds, svtkTypeBool);
  //@}
   ...
   * type requested.
   */
  svtkIdType GetTetras(int classification, svtkUnstructuredGrid* ugrid);
   ...
   * requested.
   */
  svtkIdType AddTetras(int classification, svtkUnstructuredGrid* ugrid);
   ...
   */
  svtkIdType AddTetras(int classification, svtkCellArray* connectivity);
   ...
   */
  svtkIdType AddTetras(int classification, svtkIncrementalPointLocator* locator,
   ...
   */
  svtkIdType AddTetras(int classification, svtkIdList* ptIds, svtkPoints* pts);

  /**
   * Add the triangle faces classified (2=boundary) to the connectivity
   * list provided. The method returns the number of triangles.
   */
  svtkIdType AddTriangles(svtkCellArray* connectivity);
   ...
   */
  svtkIdType AddTriangles(svtkIdType id, svtkCellArray* connectivity);
...
protected:
  svtkOrderedTriangulator();
  ~svtkOrderedTriangulator() override;
...
private:
  ...
  double Bounds[6];
  svtkTypeBool PreSorted;
  svtkTypeBool UseTwoSortIds;
  svtkHeap* Heap;

  svtkTypeBool UseTemplates;
  int CellType;
  int NumberOfCellPoints;
  int NumberOfCellEdges;
  svtkHeap* TemplateHeap;
  svtkOTTemplates* Templates;
  int TemplateTriangulation();
  void AddTemplate();
  TemplateIDType ComputeTemplateIndex();

private:
  svtkOrderedTriangulator(const svtkOrderedTriangulator&) = delete;
  void operator=(const svtkOrderedTriangulator&) = delete;
};
