/*=========================================================================
  ...
  Module:    svtkAttributesErrorMetric.cxx
...
svtkStandardNewMacro(svtkAttributesErrorMetric);

//-----------------------------------------------------------------------------
svtkAttributesErrorMetric::svtkAttributesErrorMetric()
{
...
//-----------------------------------------------------------------------------
svtkAttributesErrorMetric::~svtkAttributesErrorMetric() = default;
...
void svtkAttributesErrorMetric::SetAbsoluteAttributeTolerance(double value)
{
...
void svtkAttributesErrorMetric::SetAttributeTolerance(double value)
{
...
//-----------------------------------------------------------------------------
int svtkAttributesErrorMetric::RequiresEdgeSubdivision(
  double* leftPoint, double* midPoint, double* rightPoint, double alpha)
{
  ...
  int result;
  double ae;
  svtkGenericAttributeCollection* ac;
  ...
  svtkGenericAttribute* a = ac->GetAttribute(ac->GetActiveAttribute());
...
double svtkAttributesErrorMetric::GetError(
  double* leftPoint, double* midPoint, double* rightPoint, double alpha)
{
  assert("pre: leftPoint_exists" && leftPoint != nullptr);
  assert("pre: midPoint_exists" && midPoint != nullptr);
...
//-----------------------------------------------------------------------------
void svtkAttributesErrorMetric::PrintSelf(ostream& os, svtkIndent indent)
{
...
// obsolete.
void svtkAttributesErrorMetric::ComputeSquareAbsoluteAttributeTolerance()
{
  if (!this->DefinedByAbsolute)
  {
    if (this->GetMTime() > this->SquareAbsoluteAttributeToleranceComputeTime)
    {
      svtkGenericAttributeCollection* ac = this->DataSet->GetAttributes();
      svtkGenericAttribute* a = ac->GetAttribute(ac->GetActiveAttribute());
