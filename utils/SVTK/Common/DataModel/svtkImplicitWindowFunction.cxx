/*=========================================================================
  ...
  Module:    svtkImplicitWindowFunction.cxx
...
=========================================================================*/
#include "svtkImplicitWindowFunction.h"

#include "svtkGarbageCollector.h"
#include "svtkObjectFactory.h"

svtkStandardNewMacro(svtkImplicitWindowFunction);
svtkCxxSetObjectMacro(svtkImplicitWindowFunction, ImplicitFunction, svtkImplicitFunction);

// Construct object with window range (0,1) and window values (0,1).
svtkImplicitWindowFunction::svtkImplicitWindowFunction()
{
...
double svtkImplicitWindowFunction::EvaluateFunction(double x[3])
{
  ...
  {
    svtkErrorMacro(<< "Implicit function must be defined");
    beenWarned = true;
    return 0.0;
  }
...
void svtkImplicitWindowFunction::EvaluateGradient(double x[3], double n[3])
{
...
svtkMTimeType svtkImplicitWindowFunction::GetMTime()
{
...
void svtkImplicitWindowFunction::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkImplicitWindowFunction::Register(svtkObjectBase* o)
{
  this->RegisterInternal(o, 1);
}

//----------------------------------------------------------------------------
void svtkImplicitWindowFunction::UnRegister(svtkObjectBase* o)
{
  this->UnRegisterInternal(o, 1);
}

//----------------------------------------------------------------------------
void svtkImplicitWindowFunction ::ReportReferences(svtkGarbageCollector* collector)
{
