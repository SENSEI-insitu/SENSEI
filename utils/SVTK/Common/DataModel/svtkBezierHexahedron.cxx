/*=========================================================================
  ...
  Module:    svtkBezierHexahedron.cxx
...
svtkStandardNewMacro(svtkBezierHexahedron);

svtkBezierHexahedron::svtkBezierHexahedron()
  : svtkHigherOrderHexahedron()
{
}

svtkBezierHexahedron::~svtkBezierHexahedron() = default;

void svtkBezierHexahedron::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

svtkCell* svtkBezierHexahedron::GetEdge(int edgeId)
{
...
svtkCell* svtkBezierHexahedron::GetFace(int faceId)
{
  svtkBezierQuadrilateral* result = FaceCell;
 ...
 */
void svtkBezierHexahedron::EvaluateLocationProjectedNode(
  int& subId, const svtkIdType point_id, double x[3], double* weights)
{
  this->svtkHigherOrderHexahedron::SetParametricCoords();
  double pcoords[3];
  this->PointParametricCoordinates->GetPoint(this->PointIds->FindIdLocation(point_id), pcoords);
  this->svtkHigherOrderHexahedron::EvaluateLocation(subId, pcoords, x, weights);
}
 ...
 */
svtkHexahedron* svtkBezierHexahedron::GetApproximateHex(
  int subId, svtkDataArray* scalarsIn, svtkDataArray* scalarsOut)
{
  ...
  for (svtkIdType ic = 0; ic < 8; ++ic)
  {
    ...
    else
    {
      ...
      this->svtkHigherOrderHexahedron::EvaluateLocation(
...
void svtkBezierHexahedron::InterpolateFunctions(const double pcoords[3], double* weights)
{
  svtkBezierInterpolation::Tensor3ShapeFunctions(this->GetOrder(), pcoords, weights);
...
void svtkBezierHexahedron::InterpolateDerivs(const double pcoords[3], double* derivs)
{
  svtkBezierInterpolation::Tensor3ShapeDerivatives(this->GetOrder(), pcoords, derivs);
}

/**\brief Set the rational weight of the cell, given a svtkDataSet
 */
void svtkBezierHexahedron::SetRationalWeightsFromPointData(
...
svtkDoubleArray* svtkBezierHexahedron::GetRationalWeights()
{
  return RationalWeights.Get();
}
svtkHigherOrderCurve* svtkBezierHexahedron::getEdgeCell()
{
  return EdgeCell;
}
svtkHigherOrderQuadrilateral* svtkBezierHexahedron::getFaceCell()
{
  return FaceCell;
}
svtkHigherOrderInterpolation* svtkBezierHexahedron::getInterp()
{
  return Interp;
};
