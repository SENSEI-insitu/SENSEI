/*=========================================================================
  ...
  Module:    svtkHyperTreeGridNonOrientedSuperCursorLight.h
...
=========================================================================*/
/**
 * @class   svtkHyperTreeGridNonOrientedSuperCursorLight
...
#ifndef svtkHyperTreeGridNonOrientedSuperCursorLight_h
#define svtkHyperTreeGridNonOrientedSuperCursorLight_h

#include "svtkCommonDataModelModule.h" // For export macro
#include "svtkObject.h"
#include "svtkSmartPointer.h" // Used internally

#include "svtkHyperTreeGridLevelEntry.h" // Used internally
...
class SVTKCOMMONDATAMODEL_EXPORT svtkHyperTreeGridNonOrientedSuperCursorLight : public svtkObject
{
public:
  svtkTypeMacro(svtkHyperTreeGridNonOrientedSuperCursorLight, svtkObject);
   ...
   */
  virtual svtkHyperTreeGridNonOrientedSuperCursorLight* Clone();
...
protected:
   ...
   * Destructor
   */
  ~svtkHyperTreeGridNonOrientedSuperCursorLight() override;
  ...
  std::vector<svtkHyperTreeGridLevelEntry> Entries;
...
private:
  svtkHyperTreeGridNonOrientedSuperCursorLight(
    const svtkHyperTreeGridNonOrientedSuperCursorLight&) = delete;
  void operator=(const svtkHyperTreeGridNonOrientedSuperCursorLight&) = delete;
};
