...
Module:    svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight.cxx
...
svtkStandardNewMacro(svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight);

#include "svtkHyperTreeGridNonOrientedVonNeumannSuperCursorData.cxx"

//-----------------------------------------------------------------------------
void svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight::Initialize(
...
//-----------------------------------------------------------------------------
void svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight::PrintSelf(ostream& os, svtkIndent indent)
{
  os << indent << "--svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight--" << endl;
