/*=========================================================================
  ...
  Module:    svtkStaticEdgeLocatorTemplate.h
...
=========================================================================*/
/**
 * @class   svtkStaticEdgeLocatorTemplate
 * @brief   templated locator for managing edges and associated data on edges
 *
 *
 * svtkStaticEdgeLocatorTemplate provides methods for ordering and tracking
 ...
 * additions of new edges is not allowed (analogoues to svtkStaticPointLocator
 * and svtkStaticCellLocator).
 *
 ...
 *
 * @sa
 * svtkEdgeTable svtkStaticPointLocator svtkStaticCellLocator
 */

#ifndef svtkStaticEdgeLocatorTemplate_h
#define svtkStaticEdgeLocatorTemplate_h
 ...
 * sort) by using smaller types (32-int versus 64-bit svtkIdType). It is
 ...
 * versus 64-bit svtkIdType). It is required that V0 < V1.
 */
template <typename TId, typename TED>
struct MergeTuple
{
...
public:
   ...
   */
  ~svtkStaticEdgeLocatorTemplate() { delete[] this->EdgeOffsets; }
  ...
  const IDType* MergeEdges(
    svtkIdType numEdges, MergeTupleType* edgeArray, svtkIdType& numUniqueEdges);
   ...
   * svtkSMPTools::Sort(). The provided array is modified in place. The
   * method returns the number of unique edges.
   */
  svtkIdType BuildLocator(svtkIdType numEdges, EdgeTupleType* edgeArray);
...
private:
  svtkStaticEdgeLocatorTemplate(const svtkStaticEdgeLocatorTemplate&) = delete;
  void operator=(const svtkStaticEdgeLocatorTemplate&) = delete;
};

#include "svtkStaticEdgeLocatorTemplate.txx"

#endif
// SVTK-HeaderTest-Exclude: svtkStaticEdgeLocatorTemplate.h
