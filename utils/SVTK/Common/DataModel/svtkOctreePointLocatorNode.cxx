/*=========================================================================
  ...
  Module:    svtkOctreePointLocatorNode.cxx
...
svtkStandardNewMacro(svtkOctreePointLocatorNode);

//----------------------------------------------------------------------------
svtkOctreePointLocatorNode::svtkOctreePointLocatorNode()
  : NumberOfPoints(0)
  , Children(nullptr)
  , ID(-1)
  , MinID(-1)
{
  ...
  for (int i = 0; i < 3; i++)
  {
    this->MinDataBounds[i] = SVTK_DOUBLE_MAX;
    this->MaxDataBounds[i] = SVTK_DOUBLE_MIN;
    this->MinBounds[i] = SVTK_DOUBLE_MAX;
    this->MaxBounds[i] = SVTK_DOUBLE_MIN;
  }
}
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::CreateChildNodes()
{
  if (!this->Children)
  {
    int i;
    ...
    this->Children = new svtkOctreePointLocatorNode*[8];
    for (i = 0; i < 8; i++)
    {
      this->Children[i] = svtkOctreePointLocatorNode::New();
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::DeleteChildNodes()
{
  if (this->Children)
  {
    for (int i = 0; i < 8; i++)
...
//----------------------------------------------------------------------------
svtkOctreePointLocatorNode* svtkOctreePointLocatorNode::GetChild(int i)
{
  if (this->Children)
  {
...
//----------------------------------------------------------------------------
int svtkOctreePointLocatorNode::GetSubOctantIndex(double* point, int CheckContainment)
{
  int i, index = 0;
  if (CheckContainment)
  {
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::ComputeOctreeNodeInformation(
  svtkOctreePointLocatorNode* Parent, int& NextLeafId, int& NextMinId, float* coordinates)
{
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::SetBounds(
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::GetBounds(double* b) const
{
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::SetDataBounds(
  double xMin, double xMax, double yMin, double yMax, double zMin, double zMax)
{
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::GetDataBounds(double* b) const
{
...
//
double svtkOctreePointLocatorNode::GetDistance2ToBoundary(
  double x, double y, double z, svtkOctreePointLocatorNode* top, int useDataBounds = 0)
{
...
//
double svtkOctreePointLocatorNode::GetDistance2ToBoundary(
  double x, double y, double z, double* p, svtkOctreePointLocatorNode* top, int useDataBounds = 0)
{
...
// the entire space.
//
double svtkOctreePointLocatorNode::GetDistance2ToInnerBoundary(
  double x, double y, double z, svtkOctreePointLocatorNode* top)
{
  return this->_GetDistance2ToBoundary(x, y, z, nullptr, 1, top, 0);
}

//----------------------------------------------------------------------------
double svtkOctreePointLocatorNode::_GetDistance2ToBoundary(double x, double y,
  ...
  svtkOctreePointLocatorNode* top, // the top of the octree
...
//----------------------------------------------------------------------------
svtkTypeBool svtkOctreePointLocatorNode::ContainsPoint(
...
//----------------------------------------------------------------------------
int svtkOctreePointLocatorNode::IntersectsRegion(svtkPlanesIntersection* pi, int useDataBounds)
{
...
//----------------------------------------------------------------------------
void svtkOctreePointLocatorNode::PrintSelf(ostream& os, svtkIndent indent)
{
