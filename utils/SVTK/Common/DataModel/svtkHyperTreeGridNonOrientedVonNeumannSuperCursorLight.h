/*=========================================================================
  ...
  Module:    svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight.h
...
#ifndef svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight_h
#define svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight_h

#include "svtkHyperTreeGridNonOrientedSuperCursorLight.h"

class svtkHyperTreeGrid;

class SVTKCOMMONDATAMODEL_EXPORT svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight
  : public svtkHyperTreeGridNonOrientedSuperCursorLight
{
public:
  svtkTypeMacro(svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight,
    svtkHyperTreeGridNonOrientedSuperCursorLight);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight* New();
...
protected:
   ...
   * Destructor
   */
  ~svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight() override;

private:
  svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight(
    const svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight&) = delete;
  void operator=(const svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight&) = delete;
};
