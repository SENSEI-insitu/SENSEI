/*=========================================================================
  ...
  Module:    svtkImplicitDataSet.cxx
...
svtkStandardNewMacro(svtkImplicitDataSet);
svtkCxxSetObjectMacro(svtkImplicitDataSet, DataSet, svtkDataSet);
...
svtkImplicitDataSet::svtkImplicitDataSet()
{
  this->DataSet = nullptr;

  this->OutValue = -SVTK_DOUBLE_MAX;
...
// at x[3].
double svtkImplicitDataSet::EvaluateFunction(double x[3])
{
  ...
  cell =
    this->DataSet->FindAndGetCell(x, nullptr, -1, SVTK_DBL_EPSILON, subId, pcoords, this->Weights);
...
svtkMTimeType svtkImplicitDataSet::GetMTime()
{
  svtkMTimeType mTime = this->svtkImplicitFunction::GetMTime();
  svtkMTimeType DataSetMTime;
...
void svtkImplicitDataSet::EvaluateGradient(double x[3], double n[3])
{
  svtkDataArray* scalars;
  svtkCell* cell;
  svtkIdType id;
...
void svtkImplicitDataSet::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkImplicitDataSet::ReportReferences(svtkGarbageCollector* collector)
{
