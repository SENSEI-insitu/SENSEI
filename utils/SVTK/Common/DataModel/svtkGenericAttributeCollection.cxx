/*=========================================================================
  ...
  Module:    svtkGenericAttributeCollection.cxx
...
svtkStandardNewMacro(svtkGenericAttributeCollection);

class svtkGenericAttributeInternalVector
{
public:
  typedef std::vector<svtkGenericAttribute*> VectorType;
  VectorType Vector;
};
...
svtkGenericAttributeCollection::svtkGenericAttributeCollection()
{
  this->AttributeInternalVector = new svtkGenericAttributeInternalVector;
  this->AttributeIndices = new svtkIntInternalVector;
...
//----------------------------------------------------------------------------
void svtkGenericAttributeCollection::PrintSelf(ostream& os, svtkIndent indent)
{
...
int svtkGenericAttributeCollection::GetNumberOfAttributes()
{
...
//----------------------------------------------------------------------------
int svtkGenericAttributeCollection::GetNumberOfComponents()
{
  this->ComputeNumbers();
...
int svtkGenericAttributeCollection::GetNumberOfPointCenteredComponents()
{
  this->ComputeNumbers();
...
int svtkGenericAttributeCollection::GetMaxNumberOfComponents()
{
  this->ComputeNumbers();
...
unsigned long svtkGenericAttributeCollection::GetActualMemorySize()
{
  this->ComputeNumbers();
...
int svtkGenericAttributeCollection::IsEmpty()
{
...
// Description:
// Attribute `i'.
svtkGenericAttribute* svtkGenericAttributeCollection::GetAttribute(int i)
{
  assert("pre: not_empty" && !IsEmpty());
  assert("pre: valid_i" && (i >= 0) && (i < this->GetNumberOfAttributes()));
  svtkGenericAttribute* result = this->AttributeInternalVector->Vector[i];
...
int svtkGenericAttributeCollection::FindAttribute(const char* name)
{
...
int svtkGenericAttributeCollection::GetAttributeIndex(int i)
{
  assert("pre: valid_i" && i >= 0 && i < this->GetNumberOfAttributes());
  assert("pre: is_point_centered" && this->GetAttribute(i)->GetCentering() == svtkPointCentered);
  this->ComputeNumbers();
...
void svtkGenericAttributeCollection::InsertNextAttribute(svtkGenericAttribute* a)
{
...
void svtkGenericAttributeCollection::InsertAttribute(int i, svtkGenericAttribute* a)
{
...
void svtkGenericAttributeCollection::RemoveAttribute(int i)
{
  assert("pre: not_empty" && !this->IsEmpty());
  assert("pre: valid_i" && (i >= 0) && (i < this->GetNumberOfAttributes()));
...
void svtkGenericAttributeCollection::Reset()
{
  for (unsigned int i = 0; i < this->AttributeInternalVector->Vector.size(); ++i)
  {
    this->AttributeInternalVector->Vector[i]->Delete();
...
void svtkGenericAttributeCollection::DeepCopy(svtkGenericAttributeCollection* other)
{
...
void svtkGenericAttributeCollection::ShallowCopy(svtkGenericAttributeCollection* other)
{
  assert("pre: other_exists" && other != nullptr);
  assert("pre: not_self" && other != this);
...
svtkMTimeType svtkGenericAttributeCollection::GetMTime()
{
...
// size.
void svtkGenericAttributeCollection::ComputeNumbers()
{
  if (this->GetMTime() > this->ComputeTime)
  {
    ...
    for (int i = 0; i < c; ++i)
    {
      ...
      nb += count;
      if (this->GetAttribute(i)->GetCentering() == svtkPointCentered)
      {
        pnb += count;
...
//----------------------------------------------------------------------------
// *** ALL THE FOLLOWING METHODS SHOULD BE REMOVED WHEN svtkInformation
// will be ready.
// *** BEGIN

// Description:
// Set the scalar attribute to be processed. -1 means module.
void svtkGenericAttributeCollection::SetActiveAttribute(int attribute, int component)
{
  assert("pre: not_empty" && !IsEmpty());
...
int* svtkGenericAttributeCollection::GetAttributesToInterpolate()
{
  assert("pre: not_empty" && !IsEmpty());
...
int svtkGenericAttributeCollection::HasAttribute(int size, int* attributes, int attribute)
{
...
void svtkGenericAttributeCollection::SetAttributesToInterpolate(int size, int* attributes)
{
  assert("pre: not_empty" && !this->IsEmpty());
  assert("pre: positive_size" && size >= 0);
...
// Description:
// Set the attributes to interpolate.
void svtkGenericAttributeCollection::SetAttributesToInterpolateToAll()
{
  assert("pre: not_empty" && !this->IsEmpty());
...
//----------------------------------------------------------------------------
// *** ALL THE PREVIOUS METHODS SHOULD BE REMOVED WHEN svtkInformation
// will be ready.
// *** END
