/*=========================================================================
  ...
  Module:    svtkHyperTreeGridNonOrientedMooreSuperCursor.h
...
#ifndef svtkHyperTreeGridNonOrientedMooreSuperCursor_h
#define svtkHyperTreeGridNonOrientedMooreSuperCursor_h
...
class SVTKCOMMONDATAMODEL_EXPORT svtkHyperTreeGridNonOrientedMooreSuperCursor
  : public svtkHyperTreeGridNonOrientedSuperCursor
{
public:
  svtkTypeMacro(svtkHyperTreeGridNonOrientedMooreSuperCursor, svtkHyperTreeGridNonOrientedSuperCursor);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkHyperTreeGridNonOrientedMooreSuperCursor* New();
...
protected:
   ...
   * Constructor
   */
  svtkHyperTreeGridNonOrientedMooreSuperCursor() {}

  /**
   * Destructor
   */
  ~svtkHyperTreeGridNonOrientedMooreSuperCursor() override;

private:
  svtkHyperTreeGridNonOrientedMooreSuperCursor(
    const svtkHyperTreeGridNonOrientedMooreSuperCursor&) = delete;
  void operator=(const svtkHyperTreeGridNonOrientedMooreSuperCursor&) = delete;
};
