/*=========================================================================
  ...
  Module:    svtkStaticPointLocator.h
 ...
 *
 * svtkStaticPointLocator is a spatial search object to quickly locate points
 * in 3D.  svtkStaticPointLocator works by dividing a specified region of
 ...
 * points.
 *
 * svtkStaticPointLocator is an accelerated version of svtkPointLocator. It is
 ...
 *
 * @sa
 * svtkPointLocator svtkCellLocator svtkLocator svtkAbstractPointLocator
 */

#ifndef svtkStaticPointLocator_h
#define svtkStaticPointLocator_h
...
class SVTKCOMMONDATAMODEL_EXPORT svtkStaticPointLocator : public svtkAbstractPointLocator
{
public:
  /**
   ...
   * 5 points per bucket.
   */
  static svtkStaticPointLocator* New();

  //@{
  /**
   * Standard type and print methods.
   */
  svtkTypeMacro(svtkStaticPointLocator, svtkAbstractPointLocator);
...
protected:
  svtkStaticPointLocator();
  ~svtkStaticPointLocator() override;
  ...
  svtkBucketList* Buckets;       // Lists of point ids in each bucket
...
private:
  svtkStaticPointLocator(const svtkStaticPointLocator&) = delete;
  void operator=(const svtkStaticPointLocator&) = delete;
};
