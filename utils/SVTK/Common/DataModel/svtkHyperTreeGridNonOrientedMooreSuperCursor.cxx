...
Module:    svtkHyperTreeGridNonOrientedMooreSuperCursor.cxx
...
svtkStandardNewMacro(svtkHyperTreeGridNonOrientedMooreSuperCursor);

#include "svtkHyperTreeGridNonOrientedMooreSuperCursorData.cxx"

//-----------------------------------------------------------------------------
void svtkHyperTreeGridNonOrientedMooreSuperCursor::Initialize(
...
//-----------------------------------------------------------------------------
bool svtkHyperTreeGridNonOrientedMooreSuperCursor::GetCornerCursors(
  unsigned int c, unsigned int l, svtkIdList* leaves)
{
  ...
  switch (this->GetDimension())
  {
    ...
    case 3:
      ...
      break;
    default:
      svtkErrorMacro("unexpected neighborhood");
      return false;
  } // switch (N)
  ...
  {
    svtkHyperTreeGridGeometryLevelEntry& cursor = this->Entries[this->GetIndiceEntry(cursorIdx)];
...
//-----------------------------------------------------------------------------
void svtkHyperTreeGridNonOrientedMooreSuperCursor::PrintSelf(ostream& os, svtkIndent indent)
{
  os << indent << "--svtkHyperTreeGridNonOrientedMooreSuperCursor--" << endl;
  svtkHyperTreeGridNonOrientedSuperCursor::PrintSelf(os, indent);
}

//-----------------------------------------------------------------------------
svtkHyperTreeGridNonOrientedMooreSuperCursor::~svtkHyperTreeGridNonOrientedMooreSuperCursor() {}
