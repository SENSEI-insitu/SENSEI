/*=========================================================================
  ...
  Module:    svtkOctreePointLocatorNode.h
 ...
 * svtkOctreePointLocator and is not meant for general use.  It is assumed
...
#ifndef svtkOctreePointLocatorNode_h
#define svtkOctreePointLocatorNode_h
...
class SVTKCOMMONDATAMODEL_EXPORT svtkOctreePointLocatorNode : public svtkObject
{
public:
  svtkTypeMacro(svtkOctreePointLocatorNode, svtkObject);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  static svtkOctreePointLocatorNode* New();
   ...
   */
  svtkGetMacro(MinBounds, double*);
  svtkGetMacro(MaxBounds, double*);
  //@}
   ...
   */
  svtkGetMacro(MinDataBounds, double*);
  svtkGetMacro(MaxDataBounds, double*);
  //@}
   ...
   */
  svtkOctreePointLocatorNode* GetChild(int i);
  ...
  double GetDistance2ToBoundary(
    double x, double y, double z, svtkOctreePointLocatorNode* top, int useDataBounds);
  ...
  double GetDistance2ToBoundary(double x, double y, double z, double* boundaryPt,
    svtkOctreePointLocatorNode* top, int useDataBounds);
   ...
   * partitioned by the tree of svtkOctreePointLocatorNode's.
   */
  double GetDistance2ToInnerBoundary(double x, double y, double z, svtkOctreePointLocatorNode* top);
...
protected:
  svtkOctreePointLocatorNode();
  ~svtkOctreePointLocatorNode() override;

private:
  double _GetDistance2ToBoundary(double x, double y, double z, double* boundaryPt,
    int innerBoundaryOnly, svtkOctreePointLocatorNode* top, int useDataBounds);
   ...
   */
  svtkOctreePointLocatorNode** Children;
   ...
   * this Id is different than the svtkIdType used for referencing
   * the point in the data set.
   */
  int MinID;

  svtkOctreePointLocatorNode(const svtkOctreePointLocatorNode&) = delete;
  void operator=(const svtkOctreePointLocatorNode&) = delete;
};
