...
svtkStandardNewMacro(svtkQuadric);

// Construct quadric with all coefficients = 1.
svtkQuadric::svtkQuadric()
{
  for (int i = 0; i < 10; i++)
  {
...
void svtkQuadric::SetCoefficients(double a[10])
{
  bool changed = false;
...
// Set the 10 coefficients of the quadric equation.
void svtkQuadric::SetCoefficients(double a0, double a1, double a2, double a3, double a4, double a5,
  double a6, double a7, double a8, double a9)
{
  ...
  svtkQuadric::SetCoefficients(a);
}

// Evaluate quadric equation.
double svtkQuadric::EvaluateFunction(double x[3])
{
...
void svtkQuadric::EvaluateGradient(double x[3], double n[3])
{
  double* a = this->Coefficients;
...
void svtkQuadric::PrintSelf(ostream& os, svtkIndent indent)
{
