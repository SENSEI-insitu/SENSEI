...
#
# The CMake variable SVTK_MODULE_ENABLE_SVTK_${module_name} is created
...
function(svtk_fetch_module _name _description)
  # If the variable does not exist, create it and set its value to
  # DEFAULT.
  if(NOT SVTK_MODULE_ENABLE_SVTK_${_name})
    set("SVTK_MODULE_ENABLE_SVTK_${_name}" "DEFAULT"
      CACHE STRING "Enable the ${name} module. ${_description}")
    mark_as_advanced("SVTK_MODULE_ENABLE_SVTK_${_name}")
    set_property(CACHE "SVTK_MODULE_ENABLE_SVTK_${_name}"
      PROPERTY
      STRINGS "YES;WANT;DONT_WANT;NO;DEFAULT")
  endif()
  # If the variable is WANT or YES, download the module.
  if (SVTK_MODULE_ENABLE_SVTK_${_name} STREQUAL "WANT" OR
      SVTK_MODULE_ENABLE_SVTK_${_name} STREQUAL "YES" OR
      (SVTK_MODULE_ENABLE_SVTK_${_name} STREQUAL "DEFAULT" AND SVTK_BUILD_ALL_MODULES))
    svtk_download_attempt_check(Module_${_name})
