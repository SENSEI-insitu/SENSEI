...
# svtk_add_gl2ps_test_cxx([pdf] <test> [<another test> <yet another test> ...])
#
...
function(svtk_add_gl2ps_test_cxx)
  set(tests ${ARGN})
  ...
  foreach(test ${tests})
    ...
    set_tests_properties("${_svtk_build_test}Cxx-${TName}-VerifyRasterizedPNG"
      PROPERTIES
        ...
        REQUIRED_FILES
          "${_svtk_build_TEST_OUTPUT_DIRECTORY}/${TName}-raster.png"
        LABELS "${_svtk_build_test_labels}"
        )
    if(${RASTERIZE_PDF})
      ExternalData_add_test(SVTKData
        ...
        -E "${_error_threshold}"
        -V "DATA{../Data/Baseline/${TName}-rasterRef.png,:}"
        --test-file "${_svtk_build_TEST_OUTPUT_DIRECTORY}/${TName}-raster-pdf.png"
        )
      set_tests_properties("${_svtk_build_test}Cxx-${TName}-VerifyRasterizedPDFPNG"
        PROPERTIES
        DEPENDS "${_svtk_build_test}Cxx-${TName}-RasterizePNG"
        REQUIRED_FILES
        "${_svtk_build_TEST_OUTPUT_DIRECTORY}/${TName}-raster-pdf.png"
        LABELS "${_svtk_build_test_labels}"
        )
    endif()
  endforeach()
...
set(svtkTestingGL2PS_SOURCE_DIR "${CMAKE_CURRENT_LIST_DIR}")
