# Attempt to build up the path/ld_library_path/python path needed to run SVTK.
...
if(WIN32)
  set(SVTK_PATH_SHELL_SCRIPT "windows_path${cfg_bit}.bat")
  set(PATH_FORMAT "set xxx_path_var=xxx_add_path;%xxx_path_var%\r\n")
  set(PATH_VARIABLE "PATH")
  set(PATH_SEPARATOR ";")
elseif(UNIX)
  set(SVTK_PATH_SHELL_SCRIPT "unix_path${cfg_bit}.sh")
  if(APPLE)
    set(DYLD "DYLD")
  else()
    set(DYLD "LD")
...
set(PATH_FILENAME "${SVTK_BINARY_DIR}/${SVTK_PATH_SHELL_SCRIPT}")
...
if(SVTK_WRAP_PYTHON)
  ...
  string(REPLACE "xxx_add_path" "${CMAKE_BINARY_DIR}/${SVTK_PYTHON_SITE_PACKAGES_SUFFIX}" PATH_TEMP "${PATH_FORMAT}")
