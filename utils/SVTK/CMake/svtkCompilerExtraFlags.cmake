if(CMAKE_COMPILER_IS_GNUCXX)
  ...
  if(CMAKE_SYSTEM_NAME MATCHES Linux)
    option(SVTK_LINKER_FATAL_WARNINGS "Specify if linker warnings must be considered as errors." OFF)
    mark_as_advanced(SVTK_LINKER_FATAL_WARNINGS)
    if(SVTK_LINKER_FATAL_WARNINGS)
      set(SVTK_EXTRA_SHARED_LINKER_FLAGS "-Wl,--fatal-warnings")
    endif()
    set(CMAKE_SHARED_LINKER_FLAGS
      "${SVTK_EXTRA_SHARED_LINKER_FLAGS} -Wl,-lc ${CMAKE_SHARED_LINKER_FLAGS}")
  ...
  option(SVTK_EXTRA_COMPILER_WARNINGS
    "Add compiler flags to do stricter checking when building debug." OFF)
  if(SVTK_EXTRA_COMPILER_WARNINGS)
