macro (svtk_set_with_default var value)
  if (NOT ${var})
    set(${var} "${value}")
  endif ()
endmacro ()
...
# would look like:
#
#   svtk_deprecated_setting(default_setting NEW_SETTING OLD_SETTING "default value")
#   set(NEW_SETTING "${default_setting}"
#     CACHE STRING "Documentation for the setting.")
function (svtk_deprecated_setting output_default new old intended_default)
...
function (svtk_obsolete_setting old)
  if (DEFINED "${old}")
