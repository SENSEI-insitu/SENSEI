...
These scripts are now part of the SVTK source distribution.
...
- doc_header2doxygen.pl: convert the SVTK headers to the Doxygen format
- doc_version.pl: extract the SVTK version and add it to the documentation set
...
I assume that your SVTK distribution is in a 'SVTK' directory and that
you do NOT want to modify it in any ways. You would rather create a
modified copy of the SVTK files in a different location (here, the
'../SVTK-doxygen' directory, assuming that you are in the 'SVTK'
directory now). Hence, you might use this main 'SVTK' directory for CVS
...
'SVTK/Utilities/Doxygen' directory. You will also find a couple of
additional files like a SVTK logo and a batch script automating the
whole conversion process. Thus, the directories that are of some
interest in that README are:

   SVTK/ : the SVTK repository
   SVTK/Utilities/Doxygen : the Doxygen scripts and configuration files
   SVTK-Doxygen/ : the intermediate SVTK repository

The doxygen configuration script, i.e. the script controlling how this
SVTK documentation is created, is named 'doxyfile'; it is also stored
in the 'SVTK/Utilities/Doxygen' directory. It is read by doxygen and
...
filename to INPUT, just add it to the end of the list. Example:
    ...
    INPUT = ../../../SVTK-doxygen/Common ../../../SVTK-doxygen/Filtering ../../../SVTK-doxygen/Graphics ../../../SVTK-doxygen/Hybrid ../../../SVTK-doxygen/Imaging ../../../SVTK-doxygen/IO ../../../SVTK-doxygen/Parallel ../../../SVTK-doxygen/Patented ../../../SVTK-doxygen/Rendering ../../../SVTK-doxygen/doc_version.dox ../../../SVTK-doxygen/doc_class2examples.dox ../../../SVTK-doxygen/doc_class2tests.dox ../../../SVTK-doxygen/doc_index.dox
...
C0. Go to the SVTK/Utilities/Doxygen directory
    -----------------------------------------
...
For example:
    ...
    D:\src\kitware\svtk\SVTK> cd Utilities\Doxygen
    D:\src\kitware\svtk\SVTK\Utilities\Doxygen>


C1. Convert the SVTK headers to Doxygen format
    -----------------------------------------
...
For example:
    ...
    D:\src\kitware\svtk\SVTK\Utilities\Doxygen> perl doc_header2doxygen.pl --to ../../../SVTK-doxygen
...
Meaning that:
    ...
    The optional '--to ../../../SVTK-doxygen' parameter specifies that the
    script stores the modified C++ *headers* (*.h files)  in the
    '../../../SVTK-doxygen' directory (here: 'D:\src\kitware\svtk\SVTK-doxygen',
    as I issued the command from 'D:\src\kitware\svtk\SVTK\Utilities\Doxygen').
    The files located in 'SVTK' remain untouched. The script browses
    ...
    directories or files if you want to document a specific SVTK part only:
    just add these parts as parameters. Example:

    D:\src\kitware\svtk\SVTK\Utilities\Doxygen> perl doc_header2doxygen.pl --to ../../../SVTK-doxygen ../../Hybrid

Update the Doxygen configuration file ('doxyfile'):

    Depending on the location from where you are going to run Doxygen
    (here: 'D:\src\kitware\svtk\SVTK\Utilities\Doxygen') update or add
    the paths to the SVTK components/directories that you want to
    document. Since the headers have been created in
    '../../../SVTK-doxygen', the following values will be fine:

    INPUT = ../../../SVTK-doxygen/Common ../../../SVTK-doxygen/Filtering ../../../SVTK-doxygen/Graphics ../../../SVTK-doxygen/Hybrid ../../../SVTK-doxygen/Imaging ../../../SVTK-doxygen/IO ../../../SVTK-doxygen/Parallel ../../../SVTK-doxygen/Patented ../../../SVTK-doxygen/Rendering


C2. Extract SVTK version
    -------------------
...
For example:
    ...
    D:\src\kitware\svtk\SVTK\Utilities\Doxygen> perl doc_version.pl --logo "svtk-logo.gif" --to ../../../SVTK-doxygen
    doc_version.pl 0.22, by Sebastien Barre
     => 4.0.0
     => $Revision$ $Date$
    Building version documentation to ../../../SVTK-doxygen/doc_version.dox
    Finished in 0 s.

Meaning that:

    The optional '--to ../../../SVTK-doxygen' parameter specifies that
    the script stores the related documentation part in the
    '../../../SVTK-doxygen' directory (more precisely in the
    '../../../SVTK-doxygen/doc_version.dox' file). The SVTK logo is
    incorporated by using the --logo option. The script searches for
    the SVTK version in the '../../Common/svtkVersion.h'. Use --help to
...
For example:
    ...
    D:\src\kitware\svtk\SVTK\Utilities\Doxygen> perl doc_class2example.pl --link http://public.kitware.com/cgi-bin/cvsweb.cgi/~checkout~/SVTK/Utilities/Doxygen --to ../../../SVTK-doxygen
    ...
    Eliminating some classes...
     => 1 class(es) eliminated (svtkCommand) in 0 s.
    Locating headers to update...
     => 33 found, 8 orphan class(es) removed (svtkIOJava, svtkRenderingJava, svtkCommonJava, svtkImagingJava, svtkGraphicsJava, svtkInteract, svtkTkWidget, svtkFilteringJava) in 0 s.
    ...
    Writing documentation to ../../../SVTK-doxygen/doc_class2examples.dox...
...
Meaning that :
    ...
    *examples* (17 here) in the directories two level up (i.e. ../../
    ...
    the '../../../SVTK-doxygen' directory (which is good because they
    ...
    in the '../../../SVTK-doxygen/doc_class2example.dox' file. Once
    again, the files located in 'SVTK' remain untouched. The --link
...
Update the Doxygen configuration file ('doxyfile'):
    ...
    '../../../SVTK-doxygen/doc_class2example.dox') to the INPUT
...
For example:
    ...
    D:\src\kitware\svtk\SVTK\Utilities\Doxygen> perl doc_index.pl --to ../../../SVTK-doxygen
    ...
    Building pages header...
    Writing documentation to ../../../SVTK-doxygen/doc_index.dox...
...
Meaning that:
    ...
    '../../../SVTK-doxygen' directory (more precisely in the
    '../../../SVTK-doxygen/doc_index.dox' file).
...
Update the Doxygen configuration file ('doxyfile'):
    ...
    '../../../SVTK-doxygen/doc_index.dox') to the INPUT directive, so that
...
For example:
    ...
    D:\src\kitware\svtk\SVTK\Utilities\Doxygen> doxygen
