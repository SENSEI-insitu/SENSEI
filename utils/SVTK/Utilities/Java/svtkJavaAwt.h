...
#ifndef svtkJavaAwt_h
#define svtkJavaAwt_h

// for use with JAWT
#include "jawt_md.h"

#define SVTK_JAVA_DEBUG
...
extern "C" JNIEXPORT jint JNICALL Java_svtk_svtkPanel_RenderCreate(
  JNIEnv* env, jobject canvas, jobject id0)
{
  ...
  svtkRenderWindow* temp0;
  temp0 = (svtkRenderWindow*)(svtkJavaGetPointerFromObject(env, id0));

  /* Get the AWT */
  awt.version = JAWT_VERSION_1_3;
  if (JAWT_GetAWT(env, &awt) == JNI_FALSE)
  {
#ifndef SVTK_JAVA_DEBUG
...
extern "C" JNIEXPORT jint JNICALL Java_svtk_rendering_awt_svtkInternalAwtComponent_RenderCreate(
  JNIEnv* env, jobject canvas, jobject id0)
{
#if defined(WIN32_JAWT_LOCK_HACK)
  int hash;
...
// cause svtkRenderWindow to make an XLib call or to call Render().
...
extern "C" JNIEXPORT jint JNICALL Java_svtk_svtkPanel_Lock(JNIEnv* env, jobject canvas)
{
  JAWT awt;
  JAWT_DrawingSurface* ds;
  jint lock;
...
extern "C" JNIEXPORT jint JNICALL Java_svtk_svtkPanel_UnLock(JNIEnv* env, jobject canvas)
{
  JAWT awt;
  JAWT_DrawingSurface* ds;
...
#endif
// SVTK-HeaderTest-Exclude: svtkJavaAwt.h
