/*=========================================================================
  ...
  Module:    svtkWin32OutputWindowProcess.c
...
static LPCTSTR MainWindowClass = _T("svtkOutputWindowProcess");
...
#ifdef _DEBUG
#error "svtkWin32OutputWindowProcess must be compiled Release"
#endif
