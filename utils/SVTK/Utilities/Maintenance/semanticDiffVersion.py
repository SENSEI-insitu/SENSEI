#!/usr/bin/env python
"""
This script generates API changes between two different versions of SVTK.
...
# Type1: ARangeFunctor /home/sankhesh/Projects/svtk/src/Common/Core/Testing/Cxx/TestSMP.cxx /^class ARangeFunctor$/;" kind:c

# Type2: APIDiagram  /home/sankhesh/Projects/svtk/src/Charts/Core/Testing/Cxx/TestDiagram.cxx /^class APIDiagram : public svtkContextItem$/;"  kind:c  inherits:svtkContextItem

# Type3: AbortFlagOff /home/sankhesh/Projects/svtk/src/Common/Core/svtkCommand.h  /^  void AbortFlagOff()$/;" kind:f  class:svtkCommand  access:public

# Type4: BooleanSet     /home/sankhesh/Projects/svtk/src/Filters/General/svtkMultiThreshold.h     /^  class BooleanSet : public Set {$/;" kind:c  class:svtkMultiThreshold inherits:Set    access:public
...
class CompareVersions():
    ...
    def get_deprecated_methods(self):
        ...
        depMatcher = re.compile('^\+.*SVTK_LEGACY\((.*)\).*\n')
        rtDepMatcher = re.compile('^\+.*SVTK_LEGACY_BODY\((.*),\s*"(.*)"\).*\n')
