...
For each of these MRs, check if it has been merged into SVTK's release branch.
...
and assumes that the main SVTK repository is using the "origin" remote.
"""
...
merged_requests = gl.getmergerequests('svtk%2fsvtk',
