...
python svtk_submitter_summary.py
...
def scrape_cdash(date):
  ...
  #test_sysinfo_url = 'https://open.cdash.org/testSummary.php?project=11&name=svtkCommonCore-TestSystemInformation&date='+date
  test_sysinfo_url = 'https://open.cdash.org/testSummary.php?project=11&name=svtkCommonCoreCxx-TestSystemInformation&date='+date
  test_fbo_url = 'https://open.cdash.org/testSummary.php?project=11&name=svtkRenderingOpenGLCxx-TestFBO&date='+date
