...
but leaks within SVTK itself should be fixed.

To use this script:
1) setup a svtk memory check dashboard and give valgrind the
...
"${CTEST_SCRIPT_DIRECTORY}/karego-at_svtk_valgrind_suppression.txt")
