#!/usr/bin/env python
"""
Usage: python svtk_reindent_code.py [--test] <file1> [<file2> ...]

This script takes old-style "Whitesmiths" indented SVTK source files as
input, and re-indents the braces according to the new SVTK style.
...
if __name__ == "__main__":
    ...
    ignorefiles = ["lex.yy.c", "svtkParse.tab.c"]
