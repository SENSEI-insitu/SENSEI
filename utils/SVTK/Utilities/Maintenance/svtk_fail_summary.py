...
url = 'https://open.cdash.org/api/?method=build&task=sitetestfailures&project=SVTK&group=Nightly%20Expected'
...
for skey in submissions.keys():
  ...
  if csvOutput:
    ...
    print r'|-'
    print r'| ',
    print r'[https://open.cdash.org/index.php?project=SVTK' + '&date=' + dashDate + r'&filtercount=1' + r'&field1=buildname/string&compare1=61&value1=' + bname + " " + bname + "]"
    print r'|'
    print len(bfails)
