...
SET(MACRO_REGEX "svtk[A-Za-z0-9]*Macro *\\((")
SET(SEP1 "")
SET(SEP2 "")
FOREACH(s ${SYMBOLS})
...
# Find all SVTK class header files in the current directory and below.
FILE(GLOB_RECURSE SVTK_CLASS_HEADERS "svtk*.h")

# Look for potentially mangled names.
FOREACH(h ${SVTK_CLASS_HEADERS})
