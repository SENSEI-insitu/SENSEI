...
IF (NOT DEFINED CLASS)
  MESSAGE ("You did not specify the class to process. Usage: cmake -DCLASS=svtkMyClass -P NewPipeConvertPolyData" FATAL_ERROR)
ENDIF ()
...
STRING (REGEX REPLACE
  "svtkDataSetToPolyDataFilter"
  "svtkPolyDataAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkStructuredPointsToPolyDataFilter"
  "svtkPolyDataAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkRectilinearGridToPolyDataFilter"
  "svtkPolyDataAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkStructuredGridToPolyDataFilter"
  "svtkPolyDataAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkGenericDataSetToPolyDataFilter"
  "svtkPolyDataAlgorithm"
  H_CONTENTS "${H_CONTENTS}")
