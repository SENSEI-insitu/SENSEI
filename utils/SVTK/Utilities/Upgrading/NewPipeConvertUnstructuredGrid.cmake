...
IF (NOT DEFINED CLASS)
  MESSAGE ("You did not specify the class to process. Usage: cmake -DCLASS=svtkMyClass -P NewPipeConvertUnstructuredGrid" FATAL_ERROR)
ENDIF ()
...
STRING (REGEX REPLACE
  "svtkUnstructuredGridSource"
  "svtkUnstructuredGridAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkUnstructuredGridToUnstructuredGridFilter"
  "svtkUnstructuredGridAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkDataSetToUnstructuredGridFilter"
  "svtkUnstructuredGridAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkStructuredPointsToUnstructuredGridFilter"
  "svtkUnstructuredGridAlgorithm"
  H_CONTENTS "${H_CONTENTS}")

STRING (REGEX REPLACE
  "svtkGenericDataSetToUnstructuredGridFilter"
  "svtkUnstructuredGridAlgorithm"
  H_CONTENTS "${H_CONTENTS}")
