...
if (NOT undefined_symbol_flag_hash STREQUAL flags_hash)
  ...
  # `-Dsvtk_undefined_symbols_allowed` was passed on the command line; trust it.
  ...
  if (DEFINED undefined_symbol_flag_hash)
    ...
    unset(svtk_undefined_symbols_allowed CACHE)
  endif ()
...
if (NOT DEFINED "svtk_undefined_symbols_allowed")
  set(test_project_dir "${CMAKE_CURRENT_BINARY_DIR}/CMakeTmp/svtk_undefined_symbols_allowed")
...
")
  ...
  try_compile(svtk_undefined_symbols_allowed
    "${test_project_dir}"
    "${test_project_dir}"
    undefined
    CMAKE_FLAGS
  ...
  if (svtk_undefined_symbols_allowed)
    message(STATUS "Performing Test svtk_undefined_symbols_allowed - Success")
  else ()
    message(STATUS "Performing Test svtk_undefined_symbols_allowed - Failed")
    file(APPEND "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeError.log"
      "Performing Test svtk_undefined_symbols_allowed failed with the "
      "following output:\n${output}\n")
  endif ()
endif ()
